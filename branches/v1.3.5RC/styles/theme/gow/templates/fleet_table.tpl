...
<div id="content" class="content">
    <table>
		...
		<td><a class="tooltip_sticky" name="<table width='100%'><tr><th colspan='2' style='text-align:center;'>{$fl_info_detail}</th></tr>{foreach key=name item=count from=$FlyingFleetRow.FleetList}<tr><td class='transparent'>{$name}:</td><td class='transparent'>{$count}</td></tr>{/foreach}</table>">{$FlyingFleetRow.amount}</a></td>
