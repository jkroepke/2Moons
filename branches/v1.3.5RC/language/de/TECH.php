...
$LNG['info'][604]['description'] = 'Die Gilde der Technokraten sind die Wissenschafter der bekannten Genies. Man findet sie dort wo die Technik ihre Grenzen erreicht. Niemand versteht die Dechiffrierung der Kryptographie eines Technokraten, seine alleinige Präsenz inspiriert die Kontrukteure des ganzen Imperiums.<br><br><span style="color:red">-%s%% Produktionszeit von Raumschiffen. Maximal Level %s</span>';
...
$LNG['info'][607]['description'] = 'Der Lagerist beherrscht wertvolle Lagerungs- und Sortierkenntnisse. Durch hochentwickelte Lagertechniken und strukturelle Anpassungen, kann er das nutzbare Volumen eines Lageraumes deutlich erhöhen.<br><br><span style="color:red">+%s%% Lagerraum. Maximal Level. : %s</span>';
