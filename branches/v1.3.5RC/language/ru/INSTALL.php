...
$LNG['reg_not_writable']   = 'Не установлены права на запись (CHMOD 777)';
$LNG['reg_file']           = 'Файл';
$LNG['reg_dir']            = 'Папка';
$LNG['reg_gd_need']        = 'GD-Lib доступна?';
...
$LNG['step1_mysql_dbname'] = 'Название базы данных: <br> Например: Game';
$LNG['step1_mysql_dbuser'] = 'Логин: <br> Например: root';
$LNG['step1_mysql_dbpass'] = 'Пароль: <br> Например: 12345';
$LNG['step1_mysql_prefix'] = 'Префикс базы данных: <br> Например: uni1_';
