...
$LNG['password_lenght_error']        = 'Пароль должен состоять из неменее 4 символов!<br>';
...
$LNG['reg_completed']                = 'Спаасибо за регистрацию! Вы получите письмо на электронную почту с ссылкой на активацию аккаунта.';
...
$LNG['agb']                          = array(
	...
	"Предмет условий использования" => array(
		...
		"Следующие условия определяют использование онлайн-игры Moon Hunt предоставленной Demiurgi Group на своих веб-страницах.
		Регистрируясь или входя на страницу онлайн-игры Moon Hunt, www.moon-hunt.emaxihost.com, пользователи попадают на это пользовательское соглашение с Demiurgi Group.",

		"Эти условия использования полностью замещают более старые версии условий использования Moon Hunt.",

		"Demiurgi Group предлагает онлайн-игру Moon Hunt в рамках своих технических и операционных возможностей со средней годовой доступностью 95,0%.
		Это не включает периоды времени, когда использование онлайн-игры Moon Hunt прерывается или ограничивается из-за непреодолимых технических причин или из-за необходимой работы по обслуживанию без предоставления компенсации со стороны Demiurgi Group в соответствии с условиями данного соглашения.",

		"Moon Hunt постоянно подвергается дальнейшей разработке, обновлениям и адаптации.
		Таким образом, пользователь имеет возможность участвовать в онлайн-игре Moon Hunt только в текущей версии.",

		"Онлайн-игра Moon Hunt, предлагаемая Demiurgi Group, предназначена исключительно для развлечения, она не может использоваться для финансовой прибыли или в коммерческих целях.",

		"Пользователь сам/сама отвечает за совместимость и исправность программного и аппаратного обеспечения.",

		"Кроме этих условий использования, применимы существующие правила онлайн-игры Moon Hunt.
	...
	"Закрытие" => array(
		...
		"Регистрация пользователя является необходимым условием использования онлайн-игры Moon Hunt, предоставленных Demiurgi Group.",
		...
		"Принятие регистрационного заявления на сайте онлайн игры Moon Hunt имеет место посредством подтверждения регистрации по электронной почте.
	...
	"Обязательства пользователя" => array(
        ...
        <br><br>
        3.3.3. Пользователь обязан воздерживаться от любых мер, которые могут подвергать риску или прерывать должное функционирование Интернет-сайта, www.moon-hunt.emaxihost.com, и онлайн-игры Moon Hunt, а также от доступа к данным, на которые у пользователя нет прав.
	...
	"Особые условия использования онлайн-игры" => array(
		...
		"Пользователь может участвовать онлайн-игре Moon Hunt, используя только одну учетную запись в одной вселенной, если в правилах нет исключений.
		...
		<br><br>
	    а) создавать или использовать мошеннические методы, взломы и программные продукты третьих сторон, которые могут изменить результаты онлайн-игры Moon Hunt,
        <br><br>
	    б) использовать программное обеспечение, которое обеспечивает «добычу данных» или иным образом препятствует сбору информации, относящейся к онлайн-игре Moon Hunt,
        <br><br>
	    в) использовать вне онлайн-игры, покупать за настоящие деньги или продавать или менять виртуальные объекты, которые используются в онлайн-игре Moon Hunt.",
	    ...
	    "Вход разрешен только на главную страницу онлайн-игры Moon Hunt.
	...
	"Стоимость использования" => array(
		...
		"Если не указано обратное, использование онлайн-игры Moon Hunt является бесплатным.",
	...
	"Длительность контракта; удаление учетной записи пользователя" => array(
		...
		"Если не указано обратное, контракт на использование онлайн-игры Moon Hunt заключается на неограниченный период.
        ...
        <br><br>
	    е) пользователь виртуальных объектов, которые используются в онлайн-игре Moon Hunt, использует их за пределами игры, пытается продать или купить за «реальные» деньги или пытается поменять,
        <br><br>
