...
$LNG['step1_notice_chmod'] = "Убедитесь, что для config.php установлены права CHMOD 777!";
...
$LNG['step2_conf_op_fail'] = "Для config.php не были установлены права CHMOD 777!";
