...
<div id="content" class="content">
	  ...
	  <tr>
		<td>
		  <table>
			...
			<tr>
			  <th><input type="button" name="galaxyLeft" value="&lt;-" onClick="galaxy_submit('galaxyLeft')"></th>
			  <th><input type="text" name="galaxy" value="{$galaxy}" size="5" maxlength="3" tabindex="1"></th>
			  <th><input type="button" name="galaxyRight" value="-&gt;" onClick="galaxy_submit('galaxyRight')"></th>
			</tr>
		   </table>
		  </td>
		  <td>
		   <table>
			<tr>
			 ...
			 <tr>
			  <th><input type="button" name="systemLeft" value="&lt;-" onClick="galaxy_submit('systemLeft')"></th>
			  <th><input type="text" name="system" value="{$system}" size="5" maxlength="3" tabindex="2"></th>
			  <th><input type="button" name="systemRight" value="-&gt;" onClick="galaxy_submit('systemRight')"></th>
			 </tr>
			</table>
		   </td>
		  </tr>
	...
	<tr>
		...
		<th colspan="7"><a href="game.php?page=fleet&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$smarty.const.MAX_PLANET_IN_SYSTEM + 1}&amp;planettype=1&amp;target_mission=15">{$gl_out_space}</a></th>
	</tr>
	<tr>
