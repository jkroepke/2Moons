...
<img src="./styles/images/Adm/arrowright.png" width="16" height="10"> {$ad_back_to_menu}</a></th>
	...
	<th><a href="#" onMouseOver='return overlib("{$ad_pla_title_l}", CENTER, OFFSETX, 120, OFFSETY, -40, WIDTH, 250);' onMouseOut='return nd();'>{$ad_pla_change_p}</a></th>
	<th><input name="change_position" type="checkbox" title="{$ad_pla_change_pp}">
	<input name="g" type="text" size="1" maxlength="1"> : <input name="s" type="text" size="3" maxlength="3"> : <input name="p" type="text" size="2" maxlength="2"></th>
</tr><tr>
