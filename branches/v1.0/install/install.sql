...
CREATE TABLE IF NOT EXISTS `prefix_planets` (
  ...
  `b_building_id` varchar(500) NOT NULL,
  `b_hangar` int(11) NOT NULL DEFAULT '0',
  `b_hangar_id` varchar(500) NOT NULL,
  ...
  `supernova` bigint(11) unsigned NOT NULL DEFAULT '0',
  `bahamut` bigint(11) unsigned NOT NULL DEFAULT '0',
  `starcatcher` bigint(11) unsigned NOT NULL DEFAULT '0',
  `ifrit` bigint(11) unsigned NOT NULL DEFAULT '0',
  `shiva` bigint(11) unsigned NOT NULL DEFAULT '0',
  `catoblepas` bigint(11) unsigned NOT NULL DEFAULT '0',
  `oxion` bigint(11) unsigned NOT NULL DEFAULT '0',
  `odin` bigint(11) unsigned NOT NULL DEFAULT '0',
  `orbital_station` bigint(11) unsigned NOT NULL DEFAULT '0',
