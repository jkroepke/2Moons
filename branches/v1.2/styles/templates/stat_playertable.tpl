...
<tr>
	...
	<td><a href="javascript:OpenPopup('game.php?page=messages&amp;mode=write&amp;id={$RangeInfo.id}','', 720, 300);"><img src="{$dpath}img/m.gif" title="{$st_write_message}" alt="{$st_write_message}"></a></td>
