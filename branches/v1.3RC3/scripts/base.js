...
{value=Math.floor(value);var unit='';var precision=3;floorWithPrecision=function(value,precision){return Math.floor(value*Math.pow(10,precision))/Math.pow(10,precision);}
...
var TimerHandler=function(interval,autostart){if(typeof(interval)=='undefined'){interval=1000;}
this._interval=interval;this._callbacks=new Array();this._intervalId=null;if(autostart!=false){this.startTimer();}}
TimerHandler.prototype.appendCallback=function(method){var index=this._callbacks.length;this._callbacks[this._callbacks.length]=method;return index;}
TimerHandler.prototype.removeCallback=function(index){this._callbacks[index]=null;}
...
TimerHandler.prototype._timer=function(){for(var i=0;i<this._callbacks.length;i++){if(this._callbacks[i]!=null){this._callbacks[i]();}}}
function GetRestTimeFormat(Secs){var s=Secs;var m=0;var h=0;if(s>59){m=Math.floor(s/60);s=s-m*60;}
