...
125 => "Com o módulo de pesquisa de astrofísica, poderás colonizar um planeta extra a cada dois desenvolvimentos desta tecnologia.<br>Poderás colonizar 6 planetas sem esta tec para começar.",
...
222 => 'Esta nave é o resultado de anos de pesquisa. Os cientístas juntaram-se para criar esse monstro chamado Titan Destroyer. Equipado com as armas mais potentes, incluindo o Canhão de Gravitação.',
...
// ----------------------------------------------------------------------------------------------------------
// oficiais
$LNG['info'][601]['name']        = "Comandante";
$LNG['info'][601]['description'] = "A posição de Comandante estabeleceu-se automaticamente na Guerra moderna. Por causa da estrutura de comandos simplificada, as instruções poderão ser processadas mais rapidamente.";
$LNG['info'][602]['name']        = "Almirante";
$LNG['info'][602]['description'] = "O Almirante de frota é um experiente veterano de Guerra e estratega também.. Nos combates mais difíceis, ele é capaz de definir uma estratégia e transmiti-la aos seus subordinados. Um sábio imperador pode confiar no seu suporte em batalhas.";
$LNG['info'][603]['name']        = "Engenheiro";
$LNG['info'][603]['description'] = "O engenheiro é especialista na gestão de energia. Em épocas de paz, aumenta a energia de todas as tuas colónias. Em caso de ataque, assegura a fonte de energia aos canhões defensivos, evitando uma eventual sobrecarga, reduzindo deste modo as perdas na batalha.";
$LNG['info'][604]['name']        = "Geólogo";
$LNG['info'][604]['description'] = "O Geólogo é um experiente astromineralogista e cristalografista. Ele assiste as suas equipas de metalurgia e química assim como cuida das comunicações interplanetárias optimizando o seu uso e na refinação das matérias-primas por todo o império.";
$LNG['info'][605]['name']        = "Tecnocrata";
$LNG['info'][605]['description'] = "A Ordem dos cientistas é composta por grandes génios. Podes encontrá-los sempre a discutir questôes que desafiariam a lógica de qualquer pessoa. Nenhuma pessoa normal conseguirá descobrir o código desta ordem, e é a sua presença que inspira todos investigadores no Império a conseguir mais e melhor.";
