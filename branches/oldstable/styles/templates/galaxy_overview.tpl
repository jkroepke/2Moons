...
<div id="content">
	...
	<tr>
		<td>
			<a href="?page=fleet&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=1">{$planet}</a>
		</td>
		...
		<td style="white-space: nowrap;">
			{if $GalaxyRow.ally}
			<a class="tooltip_sticky" name="<table style='width:240px'><tr><th>{lang}gl_alliance{/lang} {$GalaxyRow.ally.name} {$GalaxyRow.ally.member}</th></tr><td><table><tr><td><a href='?page=alliance&amp;mode=ainfo&amp;a={$GalaxyRow.ally.id}'>{lang}gl_alliance_page{/lang}</a></td></tr><tr><td><a href='?page=statistics&amp;start={$GalaxyRow.ally.rank}&amp;who=2'>{lang}gl_see_on_stats{/lang}</a></td></tr>{if $GalaxyRow.ally.web}<tr><td><a href='{$GalaxyRow.ally.web}' target='allyweb'>{lang}gl_alliance_web_page{/lang}</td></tr>{/if}</table></td></table>">
				<span class="galaxy-alliance{if $GalaxyRow.ally.inally} galaxy-alliance-member{/if}">{$GalaxyRow.ally.tag}</span>
			</a>
			{else}-{/if}
		</td>
		<td style="white-space: nowrap;">
	...
	{elseif !empty($GalaxyRow)}
		<td></td>
		<td style="white-space: nowrap;">{$GalaxyRow}</td>
	...
	<tr>
		...
		<td colspan="2">
			<a class="tooltip" name="<table style='width:240px'><tr><th colspan='2'>{lang}gl_legend{/lang}</td></tr><tr><td style='width:220px'>{lang}gl_strong_player{/lang}</td><td><span class='galaxy-short-strong'>{lang}gl_short_strong{/lang}</span></td></tr><tr><td style='width:220px'>{lang}gl_week_player{/lang}</td><td><span class='galaxy-short-noob'>{lang}gl_short_newbie{/lang}</span></td></tr><tr><td style='width:220px'>{lang}gl_vacation{/lang}</td><td><span class='galaxy-short-vacation'>{lang}gl_short_vacation{/lang}</span></td></tr><tr><td style='width:220px'>{lang}gl_banned{/lang}</td><td><span class='galaxy-short-banned'>{lang}gl_short_ban{/lang}</span></td></tr><tr><td style='width:220px'>{lang}gl_inactive_seven{/lang}</td><td><span class='galaxy-short-inactive'>{lang}gl_short_inactive{/lang}</span></td></tr><tr><td style='width:220px'>{lang}gl_inactive_twentyeight{/lang}</td><td><span class='galaxy-short-longinactive'>{lang}gl_short_long_inactive{/lang}</span></td></tr></table>">{lang}gl_legend{/lang}</a> 
		</td>
	</tr>
	<tr>
