...
$lang['helpItemDescQueryClose'] = '關閉一間私人房：';
...
$lang['helpItemDescNick'] = '換暱稱：';
$lang['helpItemCodeNick'] = '/nick 使用者帳號';
$lang['settings'] = '選項設定';
$lang['settingsBBCode'] = '使用BBCode：';
$lang['settingsBBCodeImages'] = '使用圖形的BBCode：';
$lang['settingsBBCodeColors'] = '使用字體顏色的BBCode：';
$lang['settingsHyperLinks'] = '使用超連結：';
$lang['settingsLineBreaks'] = '使用換行符號';
$lang['settingsEmoticons'] = '使用表情圖示：';
$lang['settingsAutoFocus'] = '自動把遊標切換至輸入框：';
...
$lang['settingsBlink'] = '有新訊息時閃動程式標題：';
$lang['settingsBlinkInterval'] = '每毫秒閃幾下：';
$lang['settingsBlinkIntervalNumber'] = '標題閃動的次數：';
$lang['playSelectedSound'] = '試聽';
$lang['requiresJavaScript'] = '請打開JavaScript才能登入！';
$lang['errorInvalidUser'] = '不能使用的使用者名稱……';
$lang['errorUserInUse'] = '使用者名稱使用中……';
$lang['errorBanned'] = '使用者或IP已被封鎖……';
$lang['errorMaxUsersLoggedIn'] = '聊天室已客滿→無法登入……';
$lang['errorChatClosed'] = '聊天室關閉中……';
