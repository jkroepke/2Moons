...
class ShowGalaxyPage extends AbstractPage
{
	...
	public function show()
	{
        ...
        $this->tplObj->assign_vars(array(
			...
			'currentmip'				=> $PLANET[$GLOBALS['ELEMENT'][503]['name']],
			'grecyclers'   				=> $PLANET[$GLOBALS['ELEMENT'][219]['name']],
			'recyclers'   				=> $PLANET[$GLOBALS['ELEMENT'][209]['name']],
			'spyprobes'   				=> $PLANET[$GLOBALS['ELEMENT'][210]['name']],
			'missile_count'				=> sprintf($LNG['gl_missil_to_launch'], $PLANET[$GLOBALS['ELEMENT'][503]['name']]),
