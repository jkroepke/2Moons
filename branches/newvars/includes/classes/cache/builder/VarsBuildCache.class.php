...
class VarsBuildCache
{
	function buildCache()
	{
		$flags	= array(ELEMENT_BUILD, ELEMENT_TECH, ELEMENT_FLEET, ELEMENT_DEFENSIVE, ELEMENT_OFFICIER, ELEMENT_PREMIUM, ELEMENT_RACE, ELEMENT_PLANET_RESOURCE, 
		...
		while($varsRow = $GLOBALS['DATABASE']->fetchArray($varsResult)) {
			$ELEMENT['ELEMENT'][$varsRow['elementID']]	= array(
				...
				'bonus'			=> array(
					...
					'ResourceID901'			=> $varsRow['bonusResourceID901'],
					'ResourceID902'			=> $varsRow['bonusResourceID902'],
					'ResourceID903'			=> $varsRow['bonusResourceID903'],
					'ResourceID911'			=> $varsRow['bonusResourceID911'],
					'ResourceID921'			=> $varsRow['bonusResourceID921'],
