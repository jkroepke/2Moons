...
class MissionCaseSpy extends MissionFunctions
{
	...
	function TargetEvent()
	{
		...
		$template->assign_vars(array(
			...
			'title'			=> sprintf($LNG['sys_mess_head'], $targetPlanet['name'], $targetPlanet['galaxy'], $targetPlanet['system'], $targetPlanet['planet'], DateUtil::formatDate($LNG['php_tdformat'], $this->_fleet['fleet_end_time'], $targetUser['timezone'], $LNG)),
		));
