...
<td><a href="?page=news&amp;action=delete&amp;id={$NewsRow.id}" onclick="return confirm('{$NewsRow.confirm}');"><img border="0" src="./styles/images/alliance/CLOSE.png" width="16" height="16"></a></td>
</tr>
{/foreach}
