...
$LNG['registerPasswordReplay']		= 'Подтвердить пароль';
...
$LNG['registerEmailReplay']			= 'Подтвердить электронную почту';
...
$LNG['registerErrorPasswordLength']	= 'Пароль должен содержать не менее 6 символов.';
