...
<tr><th width="50%">{$qe_idq}:</th><th width="50%">{$id}</th></tr>
...
<tr><th width="30%">{$Element.name}:</th><th width="30%">{$Element.count}</th><th width="40%"><input name="{$Element.type}" type="text" value="{$Element.input}"></th>
{/foreach}
</table>
<table width="100%" style="color:#FFFFFF">
<tr>
