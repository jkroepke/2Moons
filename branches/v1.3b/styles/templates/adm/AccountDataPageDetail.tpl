...
<table class="tableunique">
	...
	<tr>
		...
		<td class="unico">
			...
			<tr><th colspan="3" class="total">{$ac_total_points}<span style="color:#FF0000">{$total_points}</span></th></tr>
			</table>
			<br>
			</div>
		...
		<td class="unico">
			...
			<tr><th colspan="3">{$ac_total_points}<span style="color:#FF0000">{$total_points_ali}</span></th></tr>
			</table>
			<br>
			</div>
			</div>
