...
function CreateOnePlanetRecord($Galaxy, $System, $Position, $Universe, $PlanetOwnerID, $PlanetName = '', $HomeWorld = false, $AuthLevel = 0, $LNG, GeneralFunctions $gf, pdo_database $db)
{
	...
	if($gf->CheckPlanetIfExist($Galaxy, $System, $Position, $Universe))
	{
		return false;
	}
	...
	$Name				= !empty($PlanetName) ? $PlanetName : $LNG['type_planet'][1];
