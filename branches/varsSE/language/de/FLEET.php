...
$LNG['sys_mess_spy_destroyed'] 				= 'Deine Spionagesonden wurden zerstört!';
$LNG['sys_adress_planet'] 					= '[%s:%s:%s]';

$LNG['sys_stat_mess_stay']           		= 'Stationierte Flotte';
$LNG['sys_stat_mess'] 		         		= 'Deine Flotte erreicht den Planeten %s und liefert %s.';
...
$LNG['sys_expe_found_goods'] 				= "Deine Forscher haben einen rohstoffreichen Planeten gefunden!<br>Sie haben %s abgebaut";
...
$LNG['sys_expe_back_home'] 					= 'Deine Flotte ist von der Expedition wieder zurükgekehrt.<br>Sie haben % mitgebracht.';
...
$LNG['sys_tran_mess_owner']		 			= 'Eine deiner Flotten erreicht den Planeten %s %s und liefert %s.';
$LNG['sys_tran_mess_user'] 		 			= 'Eine friedliche Flotte von %s %s erreicht %s %s und liefert %s.';
$LNG['sys_mess_fleetback'] 					= 'Flottenrückkehr';
$LNG['sys_tran_mess_back'] 					= 'Eine deiner Flotten kehrt zum Planeten %s %s zurück.';
$LNG['sys_recy_gotten'] 					= 'Deine Recycler haben %s Gesammelt.';
$LNG['sys_gain'] 				  			= 'Gewinn';
...
$LNG['sys_gain'] 				  			= 'Gewinn';
$LNG['sys_fleet_won'] 						= 'Eine deiner Flotten kehrt vom Angriff beim Planeten %s %s zurück. Sie haben %s erbeutet';
