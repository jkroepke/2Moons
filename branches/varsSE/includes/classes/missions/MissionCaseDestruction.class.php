...
class MissionCaseDestruction extends AbstractMission
{
...
HTML;
		...
		$fleetIntoDebris	= Config::get($this->fleetData['fleet_universe'])->Fleet_Cdr;
		$defIntoDebris		= Config::get($this->fleetData['fleet_universe'])->Defs_Cdr;
		...
		{
			case "a":
				$moonDestroyChance	= round((100 - sqrt($targetPlanet['diameter'])) * sqrt($fleetAttack[$this->fleetData['fleetId']]['unit'][214]), 1);
