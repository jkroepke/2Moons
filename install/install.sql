...
CREATE TABLE IF NOT EXISTS `prefix_config` (
  ...
  `game_speed` smallint(5) unsigned NOT NULL DEFAULT '2500',
  `fleet_speed` smallint(5) unsigned NOT NULL DEFAULT '2500',
  ...
  `trade_allowed_ships` varchar(70) NOT NULL DEFAULT '202,401',
  ...
  `moon_chance` float(2,1) NOT NULL DEFAULT '1.0',
  ...
  `ttf_file` varchar(32) NOT NULL DEFAULT 'styles/arial.tff',
  PRIMARY KEY (`uni`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
