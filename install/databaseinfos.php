...
$QryInsertConfig    .= "('VERSION'          	 , '".RCINSTALL_VERSION."'), ";
...
$QryTablePlanets    .= "`mondbasis` bigint(11) unsigned NOT NULL default '0', ";
$QryTablePlanets    .= "`phalanx` bigint(11) unsigned NOT NULL default '0', ";
$QryTablePlanets    .= "`sprungtor` bigint(11) unsigned NOT NULL default '0', ";
