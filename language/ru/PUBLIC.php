...
// Описание
$LNG['gameInformations'][0]			= "Создайте экономическую и военную инфраструктуру.";
$LNG['gameInformations'][1]			= "Исследуйте новейшие технологии.";
$LNG['gameInformations'][2]			= "Создавайте альянсы и ведите переговоры с другими императорами.";
$LNG['gameInformations'][3]			= "Постройте непобедимый флот или планетарную оборону.";
