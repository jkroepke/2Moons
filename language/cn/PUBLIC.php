...
// Button
$LNG['buttonRegister']				= '立即注册！';
$LNG['buttonScreenshot']			= '截图';
...
$LNG['registerPasswordReplayDesc']	= '请输入相同的密码';
...
$LNG['registerErrorUniClosed']		= '该宇宙已经停止注册！';
$LNG['registerErrorUsernameEmpty']	= '你必须输入用户名！';
$LNG['registerErrorUsernameChar']	= '用户名只能由数字、字母、空格、下划线(_)、横杆(-)组成！';//'Your username must consist in numbers, Letters, Spaces, _, -, . only!';
