...
409 => 'Giant Shield Dome',
410 => 'Graviton cannon',
411 => 'Orbital Defense Platform',
...
1 => 'main suppliers of raw materials for the construction of load-bearing structures of buildings and ships.',
2 => 'main suppliers of raw materials for electronic components and alloys.',
3 => 'removal of water from a planet, for its low deuterium content.',
4 => 'Solar power plants generate energy from sunlight. Some buildings require energy for their operation. ',
6 => 'Shortens research time each level by 8%.',
12 => 'The nuclear power plant generates energy from fuel rods made of deuterium.',
14 => 'robot factories produce unskilled workers , which are used in the construction of planetary infrastructure. Each level increases the speed of the expansion of buildings. ',
15 => 'The microscopic size of nanomachines translates into higher operational speed. This factory produces nanomachines that are the ultimate evolution in robotics technology. Once constructed, each upgrade significantly decreases production time for buildings, ships, and defensive structures.',
21 => 'The planetary shipyard is responsible for the construction of spacecraft and defensive mechanisms. As the shipyard is upgraded, it can produce a wider variety of vehicles at a much greater rate of speed. If a nanite factory is present on the planet, the speed at which ships are constructed is massively increased.',
22 => 'storage facility for raw metal ores before they are further processed.',
23 => 'storage facility for raw crystal before it is processed further.',
24 => 'Huge tanks for the storage of the newly acquired deuterium.',
31 => 'In order to explore new technologies, operating a research station is necessary.',
...
106 => 'Using this technique, information is gained on other planets and moons.',
108 => 'With the increase of computer capacity you can command more and more fleets. Each level of computer technology will increasing the maximum number of fleet by one. ',
109 => 'weapons technology makes more efficient weapons systems. Each level of weapons technology increases the strength of ships and defence units by 10% of its base ammount. ',
110 => 'Shield technology makes more efficient shields of the ships and defenses. Each level of shield technology increases the efficiency of shields by 10% of its base ammount. ',
111 => 'Special alloys make the armor of the spaceships better. The effectiveness of the armor can thus be increased by 10% per level. ',
113 => 'The control of the different types of energy is essential for many new technologies.',
114 => 'By incorporating the 4th and 5th Dimensions, it is now possible, a new drive to explore, which is more economical and efficient.',
115 => 'The development of these engines makes some ships faster, but each level the speed increases by only 10% of its base.',
117 => 'The impulse drive is essentially an augmented fusion rocket, usually consisting of a fusion reactor,an accelerator-generator, a driver coil assembly and a vectored thrust nozzle to direct the plasma exhaust. The fusion reaction generates a highly energized plasma. This plasma, electro-plasma can be employed for propulsion, The development of these engines makes some ships faster, but each level the speed increases by 20% of its base ammount. ',
118 => 'The development of these engines makes some ships faster, but each level the speed increases by 30% of its base ammount. ',
120 => 'By combining concentrated rays of light. The beam created causes damage when striking an object.',
121 => 'Truly deadly directional beam of accelerated ions. When they are directed at an object it hits for huge damage.',
...
203 => 'The development of the small cargo has a larger loading capacity and can be further developed to drive even faster than the light fighter.',
204 => 'This is an agile, lightweight fighter ship, which is found on almost every planet. The costs are not particularly high, shield strength and capacity are very low.',
205 => 'The development of the lightweight fighter, producing the heavy fighter, whitch is better armored and has a higher attack power.',
206 => 'Armored cruisers are almost three times as strong as heavy fighters and have more than twice the power. Moreover, they are very fast.',
207 => 'Battleships usually form the backbone of a fleet. Their heavy guns, high speed and large cargo space, make them serious rivals.',
208 => 'Alien planets can be colonized with this ship.',
209 => 'The recycler can get raw materials from debris fields.',
210 => 'Espionage probes are small agile drones, which provide data over long distances on fleets and planets.',
...
601 => 'Geologist is an expert in mining and astro crystallography. Attend their equipment in metallurgy and chemistry and is also responsible for interplanetary communications to optimize the use and refinement of raw material throughout the empire.<br><br><font color="red">+5% to production of recources</font>',
602 => 'The Admiral is an experienced veteran and a skillful strategist. The hardest battle is able to get an idea of the situation and contact their admirals subordinates. A wise emperor could rely on their help during the fighting.<br><br><font color="red">+5% To shields</font>',
603 => 'The Engineer is a specialist in energy management. In peacetime, it increases the energy of all the colonies.<br><br><font color="red">+5% Energy</font>',
604 => 'The guild is composed of technocrats authentic genius, and always find that dangerous edge where it all explode into a thousand pieces before they could find an explanation and technology rational.<br><br><font color="red">-5% Of the construction time of spacecraft</font>',
605 => 'The constructor has altered their DNA, only one of these men can build an entire city in a short time.<br><br><font color="red">-10% Of the construction time</font>',
606 => 'Scientists are part of a guild to concurrent technocrats. They specialize in the improvement of technologies.<br><br><font color="red">-10% Of research time.</font>',
607 => 'Storage is part of the ancient brotherhood of the planet Hsac. His motto is to win the maximum, which is why we need huge storage space. Thus has developed a new storage technique.<br><br><font color="red">+50% Storage capacity</font>',
608 => 'The Minister of Defence is a member of the imperial army. focus on your job allows you to build a formidable defense in a short period of time.<br><br><font color="red">-50% Of the construction time for defenses</font>',
609 => 'The guard is part of the imperial army and its goal is to develop technologies that improve the planetary defenses.<br><br><font color="red">unlocks Giant Shield Dome</font>',
610 => 'Spy is an enigmatic person. No one ever saw his true face, the only way would be killed. <br><br><font color="red">+5 Espionage Level</font>',
611 => 'The commander is part of the Imperial Army has mastered the art of managing fleets. Your brain can calculate the trajectories of a large number of fleets. <br><br><font color="red">+3 Fleet slots.</font>',
612 => 'The destructor is a member of the imperial army without mercy. Slaughter everything that is on its way just for fun. It is currently developing a new method of producing the Death Star.<br><br><font color="red">2 for 1 Deathstars.</font>',
613 => 'The general is a person who has served for many years to the imperial army. manufacturers produce ships faster in its presence.<br><br><font color="red">+10% Speed of production for ships</font>',
614 => 'The Conqueror said to you the undeniable qualities of conquest. He suggests you become a Raider. The Raider is the highest level of training of the Imperial Guard Raider',
615 => 'The emperor placed under his command available to all officers in the empire, combining their skills to dominate the universe and to become an opponent almost Invinsible.',

700 => 'Increases the attack value of the ships and defenses by %s%%. The bonus is only temporary.',
701 => 'Increases the value of ships shields and defenses by %s%%. The bonus is only temporary.',
702 => 'Shorten the construction time for buildings by %s%%. The bonus is only temporary.',
703 => 'Increases resource production by %s%%. The bonus is only temporary.',
704 => 'Increases energy production by %s%%. The bonus is only temporary.',
705 => 'Shortens research time by  %s%%. The bonus is only temporary.',
706 => 'Shortens flying time by %s%%. The bonus is only temporary. Does not affect Expeditions.',
);
...
// ----------------------------------------------------------------------------------------------------------
// Energie Gebäude
$lang['info'][4]['name']          = 'Solar power plant';
...
$lang['info'][24]['name']         = 'Deuterium Storage';
...
$lang['info'][31]['name']         = 'Research Laboratory';
...
$lang['info'][34]['description']  = 'The Alliance Depot offers the possibility of friendly fleets to help in the defense by supplying them with fuel to stay in orbit longer. For each development level of the alliance depot  10,000 units per hour of deuterium to be sent to the fleet in orbit.';


// ----------------------------------------------------------------------------------------------------------
// Mond Gebäude
$lang['info'][41]['name']         = 'Moon base';
...
$lang['info'][115]['name']        = 'Combustion engine';
...
$lang['info'][216]['description'] = 'This ship is a monstrous development of the Death Star, which has increased in speed, but lost its strength.  ';
$lang['info'][217]['name']        = 'Evolution Transporter';
$lang['info'][217]['description'] = 'This Transporter was developed for Large empires, notable by its enormous cargo hold.';
$lang['info'][218]['name']        = 'Avatar';
$lang['info'][218]['description'] = 'This ship is an improvement of several vessels, and the Emperor of the battle stars.';
$lang['info'][219]['name']        = 'Giga Recycler';
$lang['info'][219]['description'] = 'This ship is a truly a gigantic Recycler with its astounding speed and huge storage room! created for large empires.';
$lang['info'][220]['name']        = 'Intergalactic Darkmatter collector';
$lang['info'][220]['description'] = 'With this ship, it is possible after long years of research to collect dark matter from the moon.';
$lang['info'][221]['name']        = 'Column thriller';
...
$lang['info'][409]['name']        = 'Giant Shield Dome';
$lang['info'][409]['description'] = 'The further development of the Large Shield Dome. It is based on the same technologies can also use considerably more energy to deter enemy attacks.';
$lang['info'][410]['name']        = 'Graviton cannon';
$lang['info'][410]['description'] = 'It is based as the name suggests, on Graviton force, better known from the Death Star.';
$lang['info'][411]['name']        = 'Orbital Defense Platform';
...
$lang['info'][601]['description'] = '<br><br>Geologist is an expert in mining and astro crystallography. Attend their equipment in metallurgy and chemistry and is also responsible for interplanetary communications to optimize the use and refinement of raw material throughout the empire.<br><br><font color="red"> +5% to production of resources. Max Level 20</font>';
$lang['info'][602]['name']    	= 'Admiral';
$lang['info'][602]['description'] = '<br><br>The Admiral is an experienced veteran and a skillful strategist. The hardest battle is able to get an idea of the situation and contact their admirals subordinates. A wise emperor could rely on their help during the fighting.<br><br><font color="red">+5% To shields. Max Level 20 </font>';
$lang['info'][603]['name']    	= 'Engineer';
$lang['info'][603]['description'] = '<br><br>The Engineer is a specialist in energy management. In peacetime, it increases the energy of all the colonies.<br><br><font color="red">+5% Energy . Max Level 10 </font>';
$lang['info'][604]['name']    	= 'Technocrat';
$lang['info'][604]['description'] = '<br><br>The guild is composed of technocrats authentic genius, and always find that dangerous edge where it all explode into a thousand pieces before they could find an explanation and technology rational.<br><br><font color="red">-5% Of the construction time of spacecraft. Max Level 10 </font>';
$lang['info'][605]['name']    	= 'Constructor';
$lang['info'][605]['description'] = '<br><br>The constructor has altered their DNA, only one of these men can build an entire city in a short time. <br><br><font color="red">-10% Of the construction time. Max Level 3 </font>';
$lang['info'][606]['name']    	= 'Scientologist';
$lang['info'][606]['description'] = '<br><br>Scientists are part of a guild to concurrent technocrats. They specialize in the improvement of technologies. <br><br><font color="red">-10% Of research time. Max Level 3 </font>';
$lang['info'][607]['name']    	= 'Storage expert';
$lang['info'][607]['description'] = '<br><br>Storage is part of the ancient brotherhood of the planet Hsac. His motto is to win the maximum, which is why we need huge storage space. Thus has developed a new storage technique. <br><br><font color="red">+50% Storage capacity. Max Level 2</font>';
$lang['info'][608]['name']    	= 'Minister of Defence';
$lang['info'][608]['description'] = '<br><br>The Minister of Defence is a member of the imperial army. focus on your job allows you to build a formidable defense in a short period of time.<br><br><font color="red">-50% Of the construction time for defenses</font>';
$lang['info'][609]['name']    	= 'Guardian';
$lang['info'][609]['description'] = '<br><br>The Guardian is part of the imperial army and its goal is to develop technologies that improve the planetary defenses.<br><br><font color="red">unlocks Giant Shield Dome</font>';
$lang['info'][610]['name']    	= 'Spy';
$lang['info'][610]['description'] = '<br><br>Spy is an enigmatic person. No one ever saw his true face, the only way would be killed. <br><br><font color="red">+5 Espionage Level. Max Level 2</font>';
$lang['info'][611]['name']    	= 'Commander';
$lang['info'][611]['description'] = '<br><br>The commander is part of the Imperial Army has mastered the art of managing fleets. Your brain can calculate the trajectories of a large number of fleets.<br><br><font color="red">+3 Fleet slots. Max Level 3 </font>';
$lang['info'][612]['name']    	= 'Destroyer';
$lang['info'][612]['description'] = '<br><br>The destructor is a member of the imperial army without mercy. Slaughter everything that is on its way just for fun. It is currently developing a new method of producing the Death Star.<br><br><font color="red">2 for 1 Deathstars. Max Level 1 </font>';
$lang['info'][613]['name']    	= 'General';
$lang['info'][613]['description'] = '<br><br>The general is a person who has served for many years to the imperial army. manufacturers produce ships faster in its presence. <br><br><font color=\"red\">+10% Speed of production for ships. Max Level 3</font>';
$lang['info'][614]['name']    	= 'Conqueror';
$lang['info'][614]['description'] = '<br><br>The Conqueror said to you the undeniable qualities of conquest. He suggests you become a Raider. The Raider is the highest level of training of the Imperial Guard Raider';
$lang['info'][615]['name']    	= 'Emperor';
$lang['info'][615]['description'] = '<br><br>The emperor placed under his command available to all officers in the empire, combining their skills to dominate the universe and to become an opponent almost Invinsible.';
