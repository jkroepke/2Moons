...
$LNG['reg_yes']				= "Oui";
$LNG['reg_no']				= "Non";
$LNG['reg_found']			= "Trouv&eacute;";
$LNG['reg_not_found']		= "Non trouv&eacute;";
...
$LNG['reg_global_need']		= "register_globals desactiv&eacute; ?";
$LNG['reg_json_need']		= "JSON disponible ?";
$LNG['req_php_need']		= "PHP-Version (min. 5.2.5)";
$LNG['req_ftp']				= "FTP";
$LNG['req_ftp_info']		= "Entrer vos acc&egrave;s FTP.";
...
$LNG['step2_db_error']		= "Impossible de cr&eacute;es la base de donn&eacute;es: %s";
$LNG['step2_db_con_fail']	= "Aucune connexion avec la base de donn&eacute;es.<br> %s";
$LNG['step2_conf_op_fail']	= "config.php n'est pas en CHMOD 777!";
$LNG['step2_db_connet_ok']	= "Connexion au tables r&eacute;ussi...";
$LNG['step2_db_create_ok']	= "Tables cr&eacute;e avec succ&egrave;s...";
$LNG['step2_conf_create']	= "config.php &agrave; &eacute;t&eacute; cr&eacute;e avec succ&egrave;s...";
$LNG['step2_prefix_invalid']	= 'Le pr&eacute;fixe DB doit contenir que des caract&egrave;res alphanum&eacute;riques et caract&egrave;res de soulignement.';

$LNG['step3_create_admin']	= "Cr&eacute;ation d'un compte Administrateur";
...
$LNG['sql_close_reason']	= 'Le jeu est actuellement ferm&eacute;';
