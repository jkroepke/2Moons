...
$LNG['sys_notenough_money'] 				= 'Sie verfügen auf Planet %s <a href="?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a> nicht über genügend Ressourcen, um mit dem Bau von %s zu beginnen. <br>Sie verfügen über: %s <br>Die Baukosten betragen %s.';
...
$LNG['mg_error_token']						= 'Nachrichten Token abgelaufen.';
$LNG['mg_error_user']						= 'Empfänger existiert nicht.';
$LNG['mg_error_text']						= 'Du musst einen Text eingeben!';
$LNG['mg_error_subject']					= 'Du musst einen Titel eingeben!';
