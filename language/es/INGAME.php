...
$LNG['ov_userbanner']						= 'Estadísticas de los jugadores en banner';
...
$LNG['gl_alliance_page']					= 'Ver página de la alianza';
$LNG['gl_see_on_stats']					= 'Ver en estadísticas';
...
$LNG['fl_dm_alert_message']				= 'Te cuidado, si en el %s %s es encontrado, tu flota será destruida!';
...
$LNG['sys_notenough_money'] 				= 'Los servicios del planeta %s <a href="?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a> No se trata, con amplios recursos, para empezar la construcción de %s . <br>Sobre las instalaciones %s %s , %s %s y %s %s. <br>El coste de la construcción es %s %s , %s %s y %s %s.';
...
$LNG['mg_type'][4]    						= 'Informes de recolección';
...
$LNG['mg_overview']						= 'Noticias Administración';
...
$LNG['al_alliance_closed']					= 'Esta alianza no admite más miembros';
$LNG['al_max_members_reached']            = 'Se ha llegado al número máximo de miembros.<br><a href="?page=alliance">Atras</a>';
...
$LNG['al_default_request_text']			= 'Los líderes de la alianza no han creado un ejemplo de solicitud, o no tienen pretenciones.';
...
$LNG['op_vacation_mode_active_message']	= 'El modo vacaciones se ha encendido. Tendra que estar de vacaciones como mínimo hasta el: ';
...
$LNG['op_dlte_account_descrip']			= 'Seleccionando esta opciones borrarás tu cuenta dentro de 7 días';
$LNG['op_not_vaild_mail']                                       = 'Usted no tiene una dirección válida de correo electrónico especificada!';
...
$LNG['op_user_name_no_alphanumeric']		= 'Por favor introduce el nombre de usuario sólo caracteres alfanuméricos!';
...
$LNG['sys_moonbuilt'] 						= "Las enormes cantidad de metal y cristal se fucionan y forman un satélite lunar en la orbita del planeta %s [%d:%d:%d] !";
...
$LNG['sys_colo_maxcolo'] 					= ", pero, por desgracia, es imposible colonizar, no puede tener más ";
$LNG['sys_colo_allisok'] 					= ", 	los colonos están comenzando a construir una nueva colonia.";
$LNG['sys_colo_badpos']  					= ", 	los colonos han encontrado un entorno propicio para la extensión de su imperio. Decidieron dar marcha atrás totalmente asqueado...";
$LNG['sys_colo_notfree'] 					= ", 	los colonos no han encontrado un planeta con estos detalles. Ellos se ven obligados a dar marcha atrás completamente desmoralizados...";
...
$LNG['sys_expe_found_ress_1_3']			= 'Tu expedición se encontró con una batalla de naves muy antigua. Los componentes individuales pueden ser recuperados y reciclados.';
$LNG['sys_expe_found_ress_1_4']			= 'La expedición se encontró con una contaminación radiactiva y muy tóxica para la atmósfera. Sin embargo, los escáneres mostraron que este asteroide es muy rico en recursos. Se usó aviones teledirigidos automáticos que trataron de obtener las materias primas.';
$LNG['sys_expe_found_ress_2_1']			= 'Tu expedición descubrió una antigua nave de carga desierta. Algunos recursos podrían ser salvados.';
...
$LNG['sys_expe_found_ress_2_3']			= 'Hemos dado un pequeño convoy de naves civiles en necesidad de alimentos y medicamentos de urgencia. A cambio, recibimos una gran cantidad de recursos útiles.';
$LNG['sys_expe_found_ress_3_1']			= 'Su flota de expedición descubrió una nave alienígena gigante. Con la tecnología no pudieron hacer nada, pero la nave podría ser descompuesta en sus componentes, a través del cual se podría obtener valiosas materias primas.';
...
$LNG['sys_expe_found_dm_1_2']				= 'Onuestra expedición había encontrado un barco fantasma que transportaba una pequeña cantidad de materia oscura. Aunque podemos encontrar ninguna evidencia de lo que ha sucedido a la tripulación original, nuestros técnicos han sido capaces de recuperar la materia oscura.';
$LNG['sys_expe_found_dm_1_3']				= 'Llevamos a un alien a un barco pequeño, que nos dejó, a cambio de unos cuantos cólculos matemáticos sencillos, nos dejó un pequeño contenedor de materia oscura.';
...
$LNG['sys_expe_found_dm_1_5']				= 'La expedición sigue algunas señales extrañas y descubrió un asteroide que tiene un núcleo con una pequeña cantidad de materia oscura. El asteroide fue traído a bordo y los investigadores ahora están tratando de extraer la materia oscura.';
$LNG['sys_expe_found_dm_2_1']				= 'Nuestra expedición ha tenido éxito en un experimento único. Se reunieron la materia oscura de una estrella moribunda.';
...
$LNG['sys_expe_found_ships_1_3']			= 'Nuestra expedición encontró un planeta que fue probablemente destruida por las guerras. En órbita hay varios naufragios. Los técnicos tratan de reparar algunos de ellos. Tal vez entonces también tengan la posibilidad de obtener información sobre lo que ha sucedido aquí.';
$LNG['sys_expe_found_ships_1_4']			= 'Tu expedición ha encontrado una vieja estrella, que probablemente ha dejado durante mucho tiempo. En el hangar de la fortaleza se encontraron unas cuantas naves. Los teócnicos analizará si algunos de ellas pueden ser reparadas o no. ';
...
$LNG['sys_expe_found_ships_2_2']			= 'Nuestra expedición se topó con un viejo astillero, automático. Algunas naves se encuentran aún en fase de producción, y nuestros ingenieros están tratando de restablecer la energía en la planta.';
$LNG['sys_expe_found_ships_3_1']			= 'Hemos encontrado un cementerio de naves espaciales gigante. Algunos técnicos de la flota de la expedición han logrado poner una o más naves de nuevo en funcionamiento.';
$LNG['sys_expe_found_ships_3_2']			= 'Hemos descubierto un planeta con los restos de una civilización. En órbita sigue habiendo una gran estación espacial conocido por ser el único edificio que sigue intacta. Algunos de nuestros técnicos y los pilotos han ido a la superficie para ver si algunos de las naves estacionados allí todavía son capaces de ser utilizadas.';
$LNG['sys_expe_lost_fleet_1']				= 'De la expedición, sólo el mensaje de radio que se quedó: Zzzrrt Oh Dios! Krrrzzzzt la zrrrtrzt krgzzzz sí parece Krzzzzzzzztzzzz ...';
$LNG['sys_expe_lost_fleet_2']				= 'Lo último que se envía por la expedición tenía algunos planos de una apertura ........ un agujero negro.';
...
$LNG['sys_expe_lost_fleet_4']				= 'La flota de expedición no pudo dar el salto hacia el espacio normal. Nuestros científicos siguen desconcertados en cuanto a lo que podría haber ocurrido, pero la flota parece ser borradas permanentemente.';
$LNG['sys_expe_time_fast_1']				= 'Una retroalimentaciín imprevista en la bobina de alimentaciín de las unidades de disco, acelerí el regreso de la expediciín, y ahora vuelve antes de lo esperado. En primer lugar informó que ella no tiene nada interesante que informar';
$LNG['sys_expe_time_fast_2']				= 'El nuevo comandante se aprovechó de algunos agujeros de gusano inestables para acortar el vuelo de vuelta - con éxito! Sin embargo, la propia expedición no ha traído ninguna prueba nueva.';
$LNG['sys_expe_time_fast_3']				= 'Su expedición no devuelve características en el sector de la investigación. Sin embargo, la flota se encontró con un hueco en el viento solar. Así, el salto fue acelerado. Tu expedición ahora viene un poco temprano para irse a casa ';
$LNG['sys_expe_time_slow_1']				= 'Un error llevó a un mal cálculo erróneo del Navegador con el salto de la expedición. No sólo es la flota desembarcó en un lugar completamente equivocado, incluso la forma en aquel entonces se tomó mucho más tiempo.';
...
$LNG['sys_expe_time_slow_3']				= 'El módulo de navegación nuevo, probablemente todavía que luchar con algunos errores. No sólo la trayectoria de la flota de la expedición fue totalmente en la dirección equivocada, incluso en su totalidad el deuterio se consumía, que terminó el salto de la flota, justo tras la salida del planeta lunar. Un poco decepcionado ahora, la expedición regresa a casa. Este regreso se retrasa, probablemente un poco.';
$LNG['sys_expe_time_slow_4']				= 'Su expedición se encontró con un sector con tormentas de partículas cada vez mayor. Esta sobrecarga de la energía de la flota y para todos las naves, los sistemas más importantes se perdieron. Su mecánico puede evitar lo peor, pero la expedición está de vuelta con algo de retraso.';
$LNG['sys_expe_time_slow_5']				= 'La nave que mandó a expedición chocó con una nave extranjera que saltó en pleno vuelo sin previo aviso a la flota. La nave alienígena explotó y los daños a las naves han sido considerables. Una vez que las reparaciones se hayan completado, tus naves estarán en el camino de regreso, porque en este estado, la expedición pudo continuar.';
$LNG['sys_expe_time_slow_6']				= 'El viento estelar ha distorsionado el salto de la expediciín tanto que se tomí algo de tiempo para calcular la devolución. Aparte de que el sector en el que la expedición salió, no es más que el vacío entre las estrellas.';
$LNG['sys_expe_nothing_1'] 				= 'Aparte de algunas criaturas extrañas, esta expedición vuelve sin nada interesante de su viaje.';
$LNG['sys_expe_nothing_2'] 				= 'Su expedición ha hecho bellas imágenes de una supernova. Realmente no hay nuevos hallazgos ha puesto esta expedición. Pero tenemos buenas posibilidades en el concurso de mejor película-de-Universo de este año.';
$LNG['sys_expe_nothing_3'] 				= 'Un virus informático extraña presentó brevemente paralizó la nave después de salir del sistema solar para navegar. Esto significaba que la flota de expedición entera todo el tiempo voló en círculo. Ni que decir tiene que la expedición no tuvo mucho éxito.';
$LNG['sys_expe_nothing_4'] 				= 'Una vida de pura energía en la que todos los miembros de la expedición había mirando a los patrones hipnóticos en las pantallas durante varios días. Cuando por fin la mayoría ha quedado claro una vez más en la cabeza, en la expedición había una grave escasez de deuterio, y la misión tuvo que ser cancelada..';
$LNG['sys_expe_nothing_5'] 				= 'Bueno, al menos ahora sabemos que tienen anomalías de color rojo en la clase 5 no es los únicos efectos caóticos sobre los sistemas marinos, pero también puede provocar alucinaciones masivas en la tripulación. Además de eso no mucho se convirtió de esta expedición.';
$LNG['sys_expe_nothing_6'] 				= 'A pesar de las exploraciones primera prometedor de este sector, por desgracia, volvemos con las manos vacías.';
$LNG['sys_expe_nothing_7'] 				= 'Tal vez no deberíamos celebrar el cumpleaños de los Capitanes en este planeta remoto. Una fiebre de la selva desagradable ha acompañado a gran parte de la tripulación obligándolos a la enfermería. tiempo de aguda personal significó que la expedición ha fallado.';
$LNG['sys_expe_nothing_8'] 				= 'Su expedición tiene, literalmente, hizo amistad con el vacío del universo. Ni siquiera había un pequeño asteroide, o radiación, o partículas, o cualquier cosa que hubiera hecho esta emocionante expedición.';
$LNG['sys_expe_nothing_9'] 				= 'Un fallo de la vasija del reactor núcleo había destruido casi toda la expedición. Afortunadamente, los ingenieros eran más que capaces y podría evitar lo peor. Sin embargo, la reparación tardó tanto tiempo, que la expedición regreó con las manos vacías.';
$LNG['sys_expe_attack_1_1_1'] 				= 'Algunos piratas espaciales aparentemente muy desesperada por tratar de secuestrar nuestra flota de expedición.';
$LNG['sys_expe_attack_1_1_2'] 				= 'Algunos bárbaros primitve nos están atacando con naves espaciales, que ni siquiera comenzar a nombre de la nave espacial. Si el bombardeo adquirir proporciones graves, vemos que el fuego nos obligó a responder.';
...
$LNG['sys_expe_attack_1_1_5'] 				= 'Nuestros informes flota de expedición que se encontraron con un tal Moa Tikarr y su manada salvaje, que exigen la rendición incondicional de nuestra flota. Si se ponen serios, tendrán que darse cuenta de que nuestros barcos defender bien.';
$LNG['sys_expe_attack_1_2_1'] 				= 'Su flota de expedición tuvo un desagradable encuentro con unos piratas del espacio.';
$LNG['sys_expe_attack_1_2_2'] 				= 'Estamos en la emboscada de alguna caída estrellas-Bucaneros! Una batalla, por desgracia, inevitable.';
$LNG['sys_expe_attack_1_2_3'] 				= 'El grito de ayuda, seguido de la expedición, resultó ser mal caso de algunos malintencionados estrellas bucaneros. La batalla era inevitable.';
$LNG['sys_expe_attack_1_3_1'] 				= 'Las señales de recogida no se originó a partir Fremdwesen, sino por una base pirata secreto! Los piratas eran conscientes de nuestra presencia en su sector y no particularmente entusiasta.';
$LNG['sys_expe_attack_1_3_2'] 				= 'La flota de expedición de los informes de fuertes combates, con barcos piratas no identificados!';
$LNG['sys_expe_attack_2_1_1'] 				= 'Su flota de expedición tuvo una primera de contacto no muy amigo de una especie desconocida.';
...
$LNG['sys_expe_attack_2_1_4'] 				= 'La flota de expedición informaron haber tenido contacto con las naves desconocidas. Los mensajes de radio no son decodificados, sin embargo parece que los buques extranjeros activado sus armas.';
$LNG['sys_expe_attack_2_2_1'] 				= 'Una especie desconocida está atacando a nuestra expedición!';
$LNG['sys_expe_attack_2_2_2'] 				= 'Su flota de expedición, al parecer, violó el territorio de la hasta ahora desconocida, pero una muy agresiva y la guerra como la raza alienígena.';
$LNG['sys_expe_attack_2_2_3'] 				= 'El enlace a nuestra flota expedición fue interrumpido. Por lo que hemos aprendido sobre el último mensaje correctamente, la flota se encuentra bajo fuego pesado - los agresores no pudieron ser identificados.';
$LNG['sys_expe_attack_2_3_1'] 				= 'Su expedición ha estado en una flota de invasión extraterrestre y reportaron intensos combates!';
$LNG['sys_expe_attack_2_3_2'] 				= 'Una asociación de gran cantidad de vasos cristalinos de origen desconocido tiene rumbo de colisión directa con nuestra flota de expedición. Ahora tenemos que asumir lo peor';
$LNG['sys_expe_attackname_1']				= 'Piratas';
$LNG['sys_expe_attackname_2'] 				= 'Aliens'; 	
$LNG['sys_expe_back_home'] 				= 'Tu expedición regresó al hangar.<br>Han traído %s %s, %s %s, %s %s y %s %s .';
$LNG['sys_expe_back_home_without_dm']		        = 'Tu expedición regresó al hangar.';
$LNG['sys_expe_back_home_with_dm']			= 'Tu expedición regresó al hangar.<br>Encontrar$oacute;n %s(%s) las naves desguazadass y se deformadas <br>El %s se podría ahorrar.';
...
$LNG['sys_notenough_money'] 				= "No tienes suficientes recursos para contruir una % s. Tienes %s de %s, %s de %s y %s de %s y el costo de la construcción era %s de %s, %s de %s y %s de %s";
...
$LNG['css_account_banned_expire']			= 'Expiración:';
...
$LNG['cff_the_position']					= 'la posición ';
...
$LNG['cff_from_position']					= 'de la posición ';
...
$LNG['cff_back_to_the_planet']                = ' están regresando de nuevo a su planeta ';
$LNG['cff_with_the_mission_of']			= '. Con la misión de: ';
...
//----------------------------------------------------------------------------//
// CombatReport.php
$LNG['cr_lost_contact']					= 'Se perdió el contacto con la flota atacante.';
...
$LNG['fa_week_player']						= 'Error, el jugador es demasiado débil';
...
$LNG['pl_destroy']    						= '%s participó en la destrucción';
