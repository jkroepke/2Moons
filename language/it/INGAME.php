...
// GAME.PHP
$LNG['see_you_soon']						= 'Grazie per aver giocato con noi, speriamo di rivederti presto!';
...
$LNG['lm_fleettrader']						= 'Vendi flotta';
...
$LNG['lm_chat']								= 'Chat';
$LNG['lm_support']							= 'Tickets di supporto';
$LNG['lm_rules']							= 'Regolamento';
$LNG['lm_battlesim']						= "Simulatore di battaglia";
...
$LNG['ov_planet_abandoned']					= 'Pianeta abbandonato con successo!';
$LNG['ov_principal_planet_cant_abanone']	= 'Non puoi abbandonare il pianeta madre!';
$LNG['ov_abandon_planet_not_possible']		= 'Non puoi abbandonare il pianeta mentre &egrave attivo e si sta costruendo o con flotta in movimento!';
$LNG['ov_wrong_pass']						= 'Password errata. Riprova!';
$LNG['ov_have_new_message']					= 'Imperatore, hai un nuovo messaggio!';
$LNG['ov_have_new_messages']				= 'Imperatore, hai [%d] nuovi messaggi!';
...
$LNG['ov_planet_rename']					= 'Rinomna';
$LNG['ov_rename_label']						= 'Nuovo nome';
$LNG['ov_fields']							= 'Campi';
$LNG['ov_developed_fields']                = 'Campi occupati';
$LNG['ov_max_developed_fields']				= 'max. campi disponibili';
$LNG['ov_fleet']							= 'flotta';
$LNG['ov_admins_online']					= 'Staff (Connesso):';
...
$LNG['ov_teamspeak_not_online']				= 'Il server &egrave attualmente offline per lavori di manutenzione. Ci scusiamo per il disagio.';
$LNG['ov_teamspeak']						= 'Teamspeak';
$LNG['ov_teamspeak_v2']						= '<a href="teamspeak://%s:%s?nickname=%s" title="Connessione Teamspeak">Connttiti</a> &bull; Connessi: %d/%d &bull; Canali: %d &bull; Traffico: %s MB';
$LNG['ov_teamspeak_v3']						= '<a href="ts3server://%s?port=%d&amp;nickname=%s&amp;password=%s" title="Connessione Teamspeak">Connettiti</a>&nbsp;&bull;&nbsp; Connessi: %d/%d &bull; Canali: %d &bull; Traffico: %s MB';
$LNG['ov_closed']							= 'Gioco temporaneamente disattivato! ';
$LNG['ov_reflink']							= 'Link amico';
$LNG['ov_noreflink']                                            = 'Avete attualmente reclutato 0 giocatori.';
//----------------------------------------------------------------------------//
//GALAXY
...
$LNG['gl_fleets']							= 'Spazi disponibili';
$LNG['gl_avaible_grecyclers']				= 'Mega reciclatrici';
$LNG['gl_avaible_recyclers']				= 'Reciclatrici';
...
$LNG['gl_debris_field']						= 'Raccogli detriti';
...
$LNG['gl_free_desc'] 						= 'Pianeta disabitato! Colonizza qui prima che qualcun\'altor lo faccia!';
$LNG['gl_free'] 							= 'Libero';
$LNG['gl_yes'] 								= 'Si';
$LNG['gl_no'] 								= 'No';
$LNG['gl_points'] 							= 'Punti';
...
$LNG['px_fleet_movement']					= 'Movimenti di flotta attuali';
...
$LNG['fl_beginning']						= 'Prosegui';
$LNG['fl_departure']						= 'Arrivo (obbiettivo)';
$LNG['fl_destiny']							= 'Destinazione';
$LNG['fl_objective']						= 'Obbiettivo';
$LNG['fl_arrival']							= 'Arrivo (ritorno)';
$LNG['fl_info_detail']						= 'Dettagli della flotta';
$LNG['fl_order']							= 'Missione';
$LNG['fl_new_mission_title']				= 'Nuova missione: seleziona flotta..';
$LNG['fl_ship_type']						= 'Tipo di nave';
$LNG['fl_ship_available']					= 'Disponibili';
...
$LNG['fl_dlte_shortcut']					= 'Elimina';
$LNG['fl_shortcut_add']						= 'Aggiungi';
$LNG['fl_shortcut_edition']					= 'Modifica scorciatoia';
$LNG['fl_shortcut_save']					= 'Salva scorciatoia';
$LNG['fl_shortcut_saved']					= 'Salvata!';
$LNG['fl_no_colony']						= 'Nessuna colonia presente';
$LNG['fl_send_fleet']						= 'Invia flotta';
$LNG['fl_fleet_speed']						= 'Velocit&agrave';
$LNG['fl_distance']							= 'Distanza';
$LNG['fl_flying_time']						= 'Tempo di volo (andata)';
$LNG['fl_flying_arrival']					= 'Arrivo all\'obbiettivo';
...
$LNG['fl_no_slots']							= 'Nessuno spazio disponibile!';
$LNG['fl_empty_transport']					= 'Non puoi trasportare 0 risorse!';
$LNG['fl_planet_populed']					= 'Questo pianeta &egrave occupato!';
$LNG['fl_no_same_alliance']					= 'Il giocatore in questione fa parte della tua alleanza!';
$LNG['fl_not_ally_deposit']					= 'Nessun deposito di alleanza';
$LNG['fl_deploy_only_your_planets']			= 'Puoi schierare flotte soltanto in un tuo pianeta!';
$LNG['fl_no_enought_deuterium']				= 'non hai abbastanza %s disponibile. Ti manca %s %s!';
$LNG['fl_no_enought_cargo_capacity']		= 'Non hai abbastanza spazio disponibile nei cargo:';
$LNG['fl_admins_cannot_be_attacked']		= 'Non puoi attaccare un membro dello staff!';
$LNG['fl_fleet_sended']						= 'Flotta inviata';
$LNG['fl_from']								= 'Da';
$LNG['fl_arrival_time']						= 'Tempo di arrivo';
$LNG['fl_return_time']						= 'Tempo di ritorno';
$LNG['fl_fleet']							= 'Flotta';
$LNG['fl_player']							= 'Giocatore ';
$LNG['fl_add_to_attack']					= ' invitato con successo.';
$LNG['fl_dont_exist']						= ' inesistente.';
...
$LNG['fl_bonus_attack']						= 'Bonus attacco';
$LNG['fl_bonus_defensive']					= 'Bonus difesa';
$LNG['fl_bonus_shield']						= 'Bonus scudo';
...
$LNG['fl_error_not_avalible']				= 'Pianeta non disponibile!';
...
$LNG['fl_bash_protect']                                         = 'Protezione Anti-Bashing';
//----------------------------------------------------------------------------//
//BUILDINGS - RESEARCH - SHIPYARD - DEFENSES
$LNG['bd_dismantle']						= 'Smantella';
$LNG['bd_interrupt']						= 'Interrompi';
$LNG['bd_cancel']							= 'Cancella';
$LNG['bd_working']							= 'In costruzione';
$LNG['bd_build']							= 'Costruisci';
...
//----------------------------------------------------------------------------//
//INFOS
$LNG['in_jump_gate_done']					= 'Salto quantico effettuato, il prossimo lo potrai fare tra: ';
$LNG['in_jump_gate_error_data']				= 'Errore, dati per il salto quantico incorretti!';
$LNG['in_jump_gate_not_ready_target']		= 'Salto quantico non disponibile, riprova tra: ';
$LNG['in_jump_gate_doesnt_have_one']		= 'Non disponete di nessun salto quantico in questa luna!';
$LNG['in_jump_gate_already_used']			= 'Salto quantico usato, riprova tra: ';
...
$LNG['in_prod_p_hour'] 						= 'produzione oraria';
$LNG['in_difference']  						= 'Differenza';
$LNG['in_used_energy'] 						= 'Consumo di energia';
$LNG['in_prod_energy'] 						= 'Produzione di energia';
...
$LNG['in_capacity']    						= 'Capacita dei cargo';
$LNG['in_units']       						= 'Unit&agrave';
$LNG['in_base_speed'] 						= 'Velocita base';
$LNG['in_consumption'] 						= 'Consumo di carburante (Deuterio)';
$LNG['in_jump_gate_start_moon']				= 'Comincia salto verso la luna';
$LNG['in_jump_gate_finish_moon']			= 'Finisci salto verso la luna';
$LNG['in_jump_gate_select_ships']			= 'Usa salto quantico: numero di navi';
...
$LNG['in_missilesamount']    				= 'Quantita di missili disponibili';

//----------------------------------------------------------------------------//
//MESSAGES
$LNG['mg_type'][0]    						= 'Rapporti di spionaggio';
...
$LNG['mg_type'][5]    						= 'Rapporti di trasporto';
$LNG['mg_type'][15]   						= 'Rapporti di spedizione';
$LNG['mg_type'][50]							= 'News di gioco';
$LNG['mg_type'][99]   						= 'Rapporti di costruzione';
$LNG['mg_type'][100]						= 'Visualizza tutti i messaggi';
$LNG['mg_type'][999]						= 'In uscita';
$LNG['mg_no_subject']						= 'Nessun oggetto';
...
$LNG['mg_write_mail_to_ops']                            = 'Scrivi una e-mail a';
//----------------------------------------------------------------------------//
//ALLIANCE
...
$LNG['al_request'] 							= 'Richieste';
$LNG['al_click_to_send_request'] 			= 'Clicca qui per fare richiesta all\'alleanza';
$LNG['al_tag_required'] 					= 'Tag dell\'alleanza mancante.';
$LNG['al_name_required'] 					= 'Nome dell\'alleanza mancante.';
$LNG['al_already_exists'] 					= 'L\'alleanza %s esiste, prova con un altro nome.';
$LNG['al_created'] 							= 'L\'alleanza %s &egrave stata creata!';
$LNG['al_continue'] 						= 'Continua';
$LNG['al_alliance_closed'] 					= 'Questa alleanza non accectta nuovi giocatori.';
$LNG['al_request_confirmation_message']		= 'L\'alleanza ha ricevuto la vostra richiesta di entrata. <br><a href="?page=alliance">Indietro</a>';
$LNG['al_default_request_text']				= 'I fondatori dell\'alleanza non hanno impostato nessun messaggio predefinito di richiesta.';
$LNG['al_write_request'] 					= 'Scrivi un messaggio per la richiesta all\'alleanza %s';
$LNG['al_request_deleted'] 					= 'Hai eliminato la richiesta. <br> Ora puoi creare o fare richiesta a un\'altra alleanza.';
$LNG['al_request_wait_message'] 			= 'Hai gi&agrave richiesto l\'entrata nell\'alleanza %s <br>';
$LNG['al_delete_request'] 					= 'Elimina richiesta';
$LNG['al_founder_cant_leave_alliance'] 		= 'Il fondatore non pu&ograve abbandonare l\'alleanza.';
...
$LNG['al_founder_rank_text']				= 'Fondatore';
$LNG['al_new_member_rank_text']				= 'Testo del richiedente';
$LNG['al_acept_request']					= 'Accetta';
$LNG['al_you_was_acceted']					= 'Hai accettato in ';
$LNG['al_hi_the_alliance']					= 'Ciao!<br>l\'alleanza <b>';
$LNG['al_has_accepted']						= '</b> ha accettato la tua richiesta.<br>Messaggio dal fondatore: <br>';
$LNG['al_decline_request']					= 'Rifiuta';
$LNG['al_you_was_declined']					= 'L\'alleanza  ';
$LNG['al_has_declined']						= '</b> ha rifiutato la tua richiesta!<br>Messaggio dal fondatore: <br>';
...
$LNG['al_tag']								= 'Tag';
$LNG['al_new_tag']							= 'Nuova tag (3-8 caratteri):';
...
$LNG['al_new_requests']						= 'Hai %d nuova/e richiesta/e';
...
$LNG['al_legend_see_connected_users']		= 'Mostra gli utenti connessi';
$LNG['al_legend_create_circular']			= 'Scrivi un messaggio circolare';
$LNG['al_legend_right_hand']				= '"Braccio destro" (necessario per trasferire il grado di fondatore)';
...
$LNG['al_Siege']        					= 'Vittorie';
$LNG['al_Drawp']        					= 'Pareggi';
$LNG['al_Loosi']        					= 'Sconfitte';
$LNG['al_KGesamt']      					= 'Combattimenti totali';
$LNG['al_Allyquote']    					= 'Statistiche dell\'alleanza';
$LNG['al_Quote']        					= 'Miglior vittoria';
...
$LNG['al_view_stats']						= 'Pubblicare i record delle battaglie in sezione pubblica?';
...
$LNG['al_diplo_level_des']                  = 'Diplomazia dell\'alleanza';
$LNG['al_diplo_text']                       = 'Teso richiesta';
$LNG['al_diplo_accept_yes']                	= 'Patto firmato ed in vigore a partire da ora!';
$LNG['al_diplo_accept_yes_mes']            	= 'Il patto di %s viene raggiunto con successo tra le alleanze %s e %s!';
$LNG['al_diplo_accept_yes_confirm']			= 'Vuoi veramente accettare il patto?';
$LNG['al_diplo_accept_no']                  = 'Patto rifiutato.';
$LNG['al_diplo_accept_no_mes']              = 'Il patto di %s tra le alleanze %s e %s non ha avuto un buon esito, viene per tanto rifiutato!';
$LNG['al_diplo_accept_no_confirm']			= 'Vuoi veramente eliminare il patto? ';
$LNG['al_diplo_delete']                    	= 'Elimina patto!';
$LNG['al_diplo_delete_mes']                	= 'Il patto di %s tra le alleanze %s e %s  viene abolito!';
$LNG['al_diplo_confirm_delete']           	= 'Vuoi veramente cancellare il patto?';
$LNG['al_diplo_ground']                    	= 'Motivazione:';
...
$LNG['al_diplo_war_mes']                    = 'L\'alleanza %s all\'alleanza %s ha dato la seguente spiegazione %s . <br>Motivo:<br>%s<br><br>Informazioni: La guerra viene considerata valida tra 24 ore. Il bashing decade tra 24 ore. <br>Troverai maggiorni informaizoni nel <a href="index.php?page=rules" target="_blank">Regolamento</a>.';
$LNG['al_leave_ally']						= 'Sei sciuro di lasciare l\'alleanza?';
$LNG['al_default_leader_name']				= 'Fondatore';

//----------------------------------------------------------------------------//
//BUDDY
$LNG['bu_request_exists']					= 'Avete gia mandato una richiesta a questo giocatore!';
$LNG['bu_cannot_request_yourself']			= 'Non puoi inviarti una richiesta di amicizia a te stesso!';
...
$LNG['bu_minutes']							= ' min.';
$LNG['bu_disconnected']						= 'Disconnesso';
...
$LNG['st_updated']							= 'Ultimo aggiornamento';
$LNG['st_show']								= 'Mostra';
$LNG['st_per']								= 'per';
...
$LNG['sh_player_name']						= 'Nome del giocatore';
...
$LNG['sh_buddy_request']					= 'Richiesta di amicizia';
...
$LNG['op_vacation_mode_active_message']		= 'Modalit&agrave vacanza attivata. Non puoi disattivarla prima di: ';
$LNG['op_end_vacation_mode']				= 'Modalit&agrave vacanza terminata.';
$LNG['op_save_changes']						= 'Salva cambiamenti';
$LNG['op_admin_title_options']				= 'Opzioni per lo staff';
$LNG['op_admin_planets_protection']			= 'Protezione dei pianeti';
$LNG['op_user_data']						= 'Dati utente';
...
$LNG['op_spy_probes_number']				= 'Numero di sonde spie da inviare';
...
$LNG['op_send_report']						= 'Invio dei rapporti';
...
$LNG['op_email_adress_descrip']				= 'Puoi cambiare indirizzo il tuo indirizzo e-mail. La nuova e-mail diventa permanente solo dopo 7 giorni se non sono stati effettuati ulteriori cambiamenti!';
$LNG['op_deactivate_ipcheck_descrip']		= 'Il controllo IP significa che avviene automaticamente il logout quando l\'indirizzo IP cambia oppure si accede all\'account da due postazioni contemporaneamente diverse tra esse.';
$LNG['op_spy_probes_number_descrip']		= 'Il numero di spie inserito indica la quantita predefinita di sonde spia che si desidera quando si effettua una spiata.';
$LNG['op_activate_vacation_mode_descrip']	= 'La modalit&agrave vacanza ti protegge nei periodi in cui non puoi connetterti. Pu&ograve essere attivata soltanto se non ci sono costruzioni, flotte o difesa in costruzione, non ci sono ricerche attive e non ci sono flotte in movimento. Se attivata, sarai protetto dagli attacchi. Durante la modalit&agrave vacanza, le produzioni saranno portate a zero e per ricominciare a produrre bisogner&agrave riportare la produzione manualmente a 100& dalla schermata Risorse. Prima di poterla successivamente disattivare dovranno passare minimo 2 giorni.';
$LNG['op_dlte_account_descrip']				= 'Se attivi questo box, il tuo account verr&agrave cancellato tra 7 giorni.';
...
$LNG['op_sort_up']							= 'Crescente';
$LNG['op_sort_down']						= 'Decrescente';
$LNG['op_user_name_no_alphanumeric']		= 'L\'username pu&ograve contenere solo caratteri alfanumerici!';
$LNG['op_change_name_pro_week']				= 'Puoi cambiare username soltato una volta ogni 7 giorni (alla settimana).';
$LNG['op_change_name_exist']				= 'Il nome %s &egrave gi&agrave esistente';
$LNG['op_active_build_messages']			= 'Rapporti di costruzione';
$LNG['op_small_storage']                    = 'Visualizza capienza risorse in deposito';
$LNG['op_dst_mode']                                                     = 'Attivare ora legale?';
$LNG['op_dst_mode_sel'][0]                                      = 'No';
$LNG['op_dst_mode_sel'][1]                                      = 'Si';
$LNG['op_dst_mode_sel'][2]                                      = 'Automatico';
$LNG['op_timezone']                                                     = 'Orario paese';
//----------------------------------------------------------------------------//
//BANNED
...
$LNG['css_account_banned_message']			= 'Siete stati bannati per qualche infrazione che avete commesso! ';
$LNG['css_account_banned_expire']			= 'Sei stato bannato fino al %s - Se desideri ulteriori informazioni a riguardo vai alla<br><a href="./index.php?page=pranger">"Lista bannati"</a>';
$LNG['css_goto_homeside']					= '<a href="./index.php">Pagina iniziale</a>';
$LNG['css_server_maintrace']				= 'Gioco attualmente sotto manutenzione.<br><br>Vi chiediamo di pazientare qualche minuto o fino al tempo prestabilito e annunciato sul forum ufficiale di gioco. <br><br>Motivo: %s';

//----------------------------------------------------------------------------//
//class.debug.php
$LNG['cdg_mysql_not_available']				= 'Connessione al database fallita!<br>Vi preghiamo di attendere e ci scusiamo inoltre per il disagio.';
$LNG['cdg_error_message']					= 'Errore! Contatta l\'amministratore: ';
$LNG['cdg_fatal_error']						= 'Errore fatale..';

//----------------------------------------------------------------------------//
//class.FlyingFleetsTable.php

$LNG['cff_no_fleet_data']					= 'Nessuna informazione disponibile sulle navi';
...
$LNG['cff_mission_target_stay']				= 'Una flotta amica %s dal giocatore %s da %s %s %s si trova in orbita da %s %s %s. Missione: %s';
...
$LNG['sys_refferal_text']					= 'I giocatori %s reclutati da te hanno ora raggiunto i punti.<br><br>Sei stato definito un "Giocatore attivo" ed hai quidi ottenuto %s %s';


//----------------------------------------------------------------------------//
// CombatReport.php
$LNG['cr_lost_contact']						= 'Contatto con la flotta perso! ';
...
$LNG['fa_not_enough_fuel']					= 'Non hai abbastanza deuterio';
$LNG['fa_no_more_slots']					= 'Non hai abbastanza spazi flotta disponibili';
$LNG['fa_no_recyclers']						= 'Nessuna reciclatrice disponbile';
$LNG['fa_no_fleetroom']						= 'Non hai abbastanza cargo per il carburante';
$LNG['fa_mission_not_available']			= 'Missione non disponibile';
$LNG['fa_no_spios']							= 'Nessuna sonda spia disponibile';
$LNG['fa_vacation_mode']					= 'Il giocatore selezionato si trova in modalit&agrave vacanza';
...
//----------------------------------------------------------------------------//
// MissilesAjax.php
$LNG['ma_silo_level']						= 'Base missilistica di livello 4 richiesta! ';
$LNG['ma_impulse_drive_required']			= 'Propulsore a impulso richiesto!';
$LNG['ma_not_send_other_galaxy']			= 'Non potete inviare missili in un\'altra galassia. ';
$LNG['ma_planet_doesnt_exists']				= 'Pianeta inesistente. ';
$LNG['ma_wrong_target']						= 'Obbiettivo errato o non esistente.';
$LNG['ma_no_missiles']						= 'Nessun missile disponibile.';
$LNG['ma_add_missile_number']				= 'Aggiungi quantita ai missili! ';
...
$LNG['ma_big_protection_shield']			= 'Cupola scudo avanzata';
$LNG['ma_all']								= 'Tutto';
$LNG['ma_missiles_sended']					= ' Missili distribuiti. Obbiettivi: ';
...
$LNG['supp_header_g'] 						= 'Tickets di supporto';
$LNG['ticket_id'] 							= '#';
$LNG['subject']                                                         = 'Oggetto';
$LNG['status'] 								= 'Stato';
$LNG['ticket_posted'] 						= 'Ticket postato il:';
$LNG['ticket_new'] 							= 'Nuovo Ticket';
$LNG['input_text'] 							= 'Testo:';
$LNG['answer_new'] 							= 'Nuova risposta:';
$LNG['text'] 								= 'Dettagli';
$LNG['message_a'] 							= 'Stato del messaggio:';
$LNG['sendit_a'] 							= 'Messaggio inserito con successo!';
...
$LNG['supp_admin_system'] 					= 'Amministra ticket';
$LNG['close_ticket'] 						= 'Chiudi ticket';
$LNG['open_ticket'] 						= 'Apri ticket';
$LNG['player'] 								= 'Nome dei giocatori';
$LNG['supp_ticket_close']					= 'Tick chiuso.';
$LNG['supp_close'] 							= 'Chiuso';
$LNG['supp_open'] 							= 'Aperto';
$LNG['supp_admin_answer'] 					= 'Lo staff ha risposto';
$LNG['supp_player_answer'] 					= 'Il giocatore ha risposto';
...
$LNG['rec_players']  						= 'Giocatore';
$LNG['rec_defes']  							= 'Difesa';
$LNG['rec_fleet']  							= 'Navi';
$LNG['rec_techn']  							= 'Ricerca';
$LNG['rec_level']  							= 'Livello';
$LNG['rec_last_update_on']   				= 'Ultimo aggiornamento: %s';
$LNG['rec_count']                                               = 'Totale';
$LNG['rec_empty']                                               = '-';
//----------------------------------------------------------------------------//
// BattleSimulator

$LNG['bs_derbis_raport']					= "Sono necessari %s %s o %s %s per raccogliere tutti i detriti. ";
$LNG['bs_steal_raport']						= "Sono necessari %s %s o %s %s o %s %s per raccogliere tutte le risorse.";
$LNG['bs_names']							= "Nome della nave";
$LNG['bs_atter']							= "Attaccante";
$LNG['bs_deffer']							= "Difensore";
$LNG['bs_steal']							= "Materiali (Difensore):";
$LNG['bs_techno']							= "Tecnologie";
$LNG['bs_send']								= "Calcola";
$LNG['bs_cancel']							= "Resetta";
$LNG['bs_wait']								= "Attendi 10 secondi per la prossima simulazione";
$LNG['bs_acs_slot']							= 'Flotta per ACS';
$LNG['bs_add_acs_slot']						= 'Aggiungi ACS';
...
//----------------------------------------------------------------------------//
// Logout
$LNG['lo_title']						= 'Disconnessione eseguita con successo! Grazie per aver giocato, speriamo di rivederti presto!';
$LNG['lo_logout']						= 'Sessione chiusa!';
$LNG['lo_redirect']						= 'Reindirizzamento in corso...';
$LNG['lo_notify']						= 'Verrai reindirizzato in <span id="seconds">5 </span>secondi';
$LNG['lo_continue']						= 'Clicca qui se non vuoi aspettare.';
