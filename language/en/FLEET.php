...
//----------------------------------------------------------------------------//
//SYSTEM
$LNG['sys_attacker_lostunits'] 				= "Altogether, the attacker has";
$LNG['sys_defender_lostunits'] 				= "Altogether, the defender has";
$LNG['sys_units']							= "units";
$LNG['debree_field_1'] 						= "Lie on these space coordinates now";
$LNG['debree_field_2']						= ".";
$LNG['sys_moonproba'] 						= "The chance of a moon emergence is: ";
$LNG['sys_moonbuilt'] 						= "The enormous amounts of free metal and crystal get dressed and form a satellite around the planet %s [%d:%d:%d] !";
...
$LNG['sys_spy_maretials'] 					= "Intelligence report of";
