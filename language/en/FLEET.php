...
$LNG['sys_attack_title']    				= "The following fleets face each other: ";
...
$LNG['sys_mess_spy_lostproba'] 				= "The probability of the destruction of the spy probes is:  %d %% ";
...
$LNG['sys_colo_maxcolo'] 					= "One of your fleets reaches the coordinates %s. A settlement is not possible here as you can have only %d planets. ";
$LNG['sys_colo_allisok'] 					= "One of your fleets reaches the coordinates %s. The settlers start to colinise the new planet.";
...
$LNG['sys_colo_notfree'] 					= "One of your fleets reaches the coordinates %s. When your settlers arrived at the coordinates they found that there is already a colony there. Demoralized completely they turned around. ";
...
$LNG['sys_expe_back_home'] 					= 'Your fleet has returned from the expedition.<br>They have delivered %s %s, %s %s, %s %s and %s %s.';
$LNG['sys_expe_back_home_without_dm']		= 'Your fleet has returned again from the expedition.';
$LNG['sys_expe_back_home_with_dm']			= 'Your fleet has returned again from the expedition.<br>They found (%s)%s but the ships deformed and were scrapped. <br>the %s was saved.';
...
$LNG['sys_destruc_echec']       		   	= 'Earthquakes shake the planet. But something goes wrong: The death stars explode and disintegrate into thousands of components. <br>The shock wave destroys the complete fleet.';
