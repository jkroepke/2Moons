...
$LNG['user_level'] = array('0' => 'Jugador', '1' => 'Moderador', '2' => 'Operador', '3' => 'Administrador', );
...
$LNG['fl_bash_protect'] = 'Bash-Protección';
...
$LNG['mg_write_mail_to_ops'] = 'Escribir un e-mail a:';
...
$LNG['op_dst_mode'] = 'Verano?';
$LNG['op_dst_mode_sel'][0] = 'No';
$LNG['op_dst_mode_sel'][1] = 'Sí';
...
//----------------------------------------------------------------------------//
//class.debug.php
$LNG['cdg_mysql_not_available'] = 'No hay conexi&oacute;n a la base de datos<br>Por favor, intentalo m&aacute;s tarde.<br><br>Pedimos disculpas por el inconveniente.';
...
$LNG['cff_mission_own_recy_0'] = 'Una %s de %s %s %s se dirige al campo de escombros %s. Misi&oacute;n: %s';
$LNG['cff_mission_own_recy_1'] = 'Una %s vuelve del campo de escombros %s hacia %s %s %s. Misi&oacute;n: %s';
...
$LNG['supp_header_g'] = 'Peticiones de Soporte';
$LNG['ticket_id'] = '#Ticket-ID';
$LNG['subject'] = 'Asunto';
$LNG['status'] = 'Estado';
$LNG['ticket_posted'] = 'petición enviada';
$LNG['ticket_new'] = 'Nueva Petición';
$LNG['input_text'] = 'Descripción:';
$LNG['answer_new'] = 'Comentar:';
$LNG['text'] = 'Detalles';
$LNG['message_a'] = 'Estado del mensaje:';
$LNG['sendit_a'] = 'El mensaje ha sido enviado.';
$LNG['message_t'] = 'Estado de la petición:';
$LNG['supp_send'] = 'Enviar';
$LNG['sendit_t'] = 'La petición ha sido enviada.';
$LNG['close_t'] = 'La petición ha sido cerrada.';
$LNG['sendit_error'] = 'Error:';
$LNG['sendit_error_msg'] = '¡Haz olvidado escribir algo!';
$LNG['supp_admin_system'] = 'Panel de administración del Soporte';
$LNG['close_ticket'] = 'Cerrar Petición';
$LNG['open_ticket'] = 'Abrir Petición';
$LNG['player'] = 'Nombre del jugador';
$LNG['supp_ticket_close'] = 'Cerrar la Petición';
$LNG['supp_close'] = 'Cerrar';
$LNG['supp_open'] = 'Abrir';
$LNG['supp_admin_answer'] = 'Respuesta del Administrador';
$LNG['supp_player_write'] = '%s escribió en %s';
