...
$LNG['rules'] = array("Cuentas" => "El propietario de una cuenta es siempre el propietario de la dirección de Correo Electrónico. A cada cuenta puede jugar un solo jugador.
...
02:01:01 Donde cada unidad de deuterio es un valor de 1 unidad de cristal o 2 unidades de metal.", "Bashing" => "Está prohibido más de cinco ataques en 24 horas sobre el mismo planeta - la luna se cuenta como un planeta aparte. Sondas de Espionaje o misiles interplanetarios no se consideran.
...
Es necesario que ambas partes de la Guerra estén de acuerdo en el foro. Las guerras que sólo sirven paraa la evasión masiva de Bashing están prohibidas. Los moderadores, operadores o administradores harán de juez para mediar posibles casos.", "Ataques de Misiles" => "Se admiten un total de 1000 misiles cada 24 horas. El número de ataques en que se envian los misiles es irrelevante", "Explotar Errores" => "La explotación de errores y / o bugs en la programación está prohibida. Los errores detectados deben ser reportados con la mayor brevedad posible por correo, en el foro de errores, IRC  o ICQ. El engaño en el reporte también  está prohibido.", "Idioma en el Juego" => "En todos los universos correspondientes se debe utilizar el idioma oficial del juego. Violaciones a esto puede ser castigado con sanciones. El uso de idiomas extranjeros en  los Mensajes /Páginas de alianza puede conducir a sanciones.", "Amenazas/Insultos" => "Extorsión y amenazas a la vida real de un jugador puede llevar a la exclusión de una o todas las áreas del juego.
Se consideran todas las amenazas y el chantaje que aparezcan tanto en una noticia del juego, foros, IRC, los canales de ICQ, mensajes entre jugadores o dentro de alianzas, donde pueda verse claramente la intención de buscar a una persona y causarle daño o a un tercero relacionado.", "Spam y Contenido adulto" => "Spam y la publicidad a sitios exteriores está prohibido. Enlaces a sitios o contenidos eróticos y pornográficos están prohibidos. ¡Se sanciona con un bloqueo en todos los universos del juego  de por vida!", "Las Reglas" => "Las reglas se pueden cambiar, y cada usuario esta obligado a mantenerse informado constantemente  sobre las mismas.", );
...
$LNG['agb'] = array("Servicios" => array("El reconocimiento de los T&C son un requisito previo necesario para poder participar en el juego.
Se aplican a todas las ofertas por parte de los operadores, incluido el Foro y otros contenidos del juego. ", "El servicio es gratuito.
Por lo tanto no existen reclamaciones a la disponibilidad, la entrega, la funcionalidad, o da&ntilde;os y perjuicios.
Ademas, el jugador no debe tener pretensiones de restaurar una cuenta tratada negativamente.", ), "Membresía" => array("Con el registro exitoso en el juego y / o en el foro se iniciará en la membrecía.", "La  membrecía puede ser finalizada en cualquier momento por parte del dueño de la cuenta como por un administrador debido a un pedido o sanción.
		La supresión de los datos, por razones técnicas no es instantánea", "En caso de que se tome una decisión por parte de un operador ningún usuario tiene derecho a reclamar o participar en las discusiones  del operador.
		...
		Cualquier reclamo a un miembro del Equipo por los eventos anteriores no posee ninguna validez legal.", "Todos los derechos sobre el juego  permanecen con el Administrador", ), "Responsabilidades/Contenidos" => "Los usuarios son responsables de todo contenido presente en las zonas de interacción (Comunicaciones entre usuarios, alianzas, imágenes) o modificación de datos presentes (descripciones, nombres de elementos) en los diversos juegos. Contenidos pornográficos, racistas, abusivos, o que vulnere alguna ley queda fuera de la responsabilidad del operador.
										Violaciones a leyes puede dar lugar a la inmediata cancelación o suspensión de la cuenta del usuario en cuestión.
										La supresión de estos contenidos se lleva a cabo lo más rápidamente posible, pero puede ser postergada por razones técnicas y / o personal por lo que no puede responsabilizarse a los administradores del juego.", "Procedimientos Prohibidos" => array("El usuario no está autorizado a usar el hardware / software o cualquier otro hecho o mecanismos asociados con el sitio web, que puede interferir con el funcionamiento normal del juego del juego.
		El usuario no puede adoptar ninguna medida que una genere carga inaceptable o problemas técnicos en el Juego.
		El usuario no puede manipular por el contenido generado por el juego, o interferir de cualquier otra manera  en el funcionamiento del mismo. ", "Cualquier tipo de bot, script o otras función automática está prohibida.
		...
		Por lo tanto, no pueden bloquearse los anuncios de publicidad dentro del juego. La decisión de cuando un software genera ventaja para el jugador es decisión del equipo del juego (Administradores, Moderadores y Operadores). ", "Un sistema automatizado ingresar a la cuenta o registrarla, independientemente de si la página se muestra o no, no está permitido", ), "Limitaciones de Uso" => array("Un jugador sólo puede usar una cuenta por universo. Los jugadores que registran y usan multicuentas están incumpliendo las normas por lo que las cuentas se pueden eliminar o sancionar sin previo aviso.
		La decisión de cuando la situación es una multicuenta corresponde exclusivamente a los  administradores, moderadores y/o operadores. ", "El jugador se compromete a cumplir con las reglas del juego.", "Los cierres de cuenta pueden ser forma permanente o temporal y esto queda a cargo del operador, moderado o administrador que reviso el hecho.
		Del mismo modo, las sanciones pueden ser e una o todas las áreas que comprende el juego.
		La decisión de cuándo y por cuánto tiempo un jugador está sancionado se encuentra únicamente en los administradores, moderadores y/o operadores. "), "Política de Privacidad" => array("El operador se reserva el derecho de almacenar los datos de los jugadores, vigilar su comportamiento para asegurar el cumplimiento de las reglas, y los T&C.
		...
		En los foros, los datos almacenados incluyen  el perfil, temas y comentarios.", "Los datos se darán a conocer en ciertas circunstancias para llevar a cabo el cumplimiento de las reglas y T&C por parte de las personas autorizadas.
		Además, si es necesario, los datos pueden ser emitidos a terceros bajo ciertas circunstancias que lo requieran.
		", "El usuario puede objetar el almacenamiento de sus datos personales en cualquier momento. Una contradicción es el derecho de rescisión, donde debe esperar que acabe el período de cierre de cuenta.", ), "Derechos del Titular de Cuenta" => array("Todas las cuentas y objetos virtuales son propiedad del equipo de administración.
		...
		La transferencia de la propiedad del juego u otros derechos  se puede llevar a cabo en cualquier momento.", "La venta no autorizada, uso, copia, distribución o violación de los derechos legales  (ej. Cuenta) por parte de jugadores u operadores será reportada a las autoridades competentes y en consecuencia procesada.
		La transferencia final de la cuenta y los recursos dentro del juego de forma gratuita está permitido, siempre y cuando no vaya la acción en contra de alguna regla o T&C.", ), "Responsabilidad" => "El titular de cada universo no se hace responsable de los daños y perjuicios.
	...
	El titular y/o los miembros del equipo no pretenden que por el juego ocurra algún tipo de daño al bienestar de los jugadores, y se desligan de toda responsabilidad por el mal o excesivo uso del juego.", "Modificación de los T&C o Reglas" => "El administrador se reserva el derecho de modificar estos términos o añadir nuevos en cualquier momento.
