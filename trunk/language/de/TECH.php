...
601 => 'Der Geologe ist ein Experte auf dem Gebiet der Astrominerologie und Astrokristallographie. Mit seinem Team aus Metall- und Chemieexperten unterstützt er die interplanetare Regierung bei der Suche nach neuen Ressourcen und bei der Optimierung von deren Abbau.<br><br><span style="color:red">+5% der Produktion</span>',
602 => 'Der Admiral der Flotte ist ein Kriegsveteran und ein Stratege. So aussichtslos die Situation auch scheint, er behält den überblick und führt die Truppen zum Sieg, wobei er stets mit den ihm unterstellten Admirälen in Kontakt bleibt. Man kann sich stets auf ihn und seine Fähigkeiten verlassen.<br><br><span style="color:red">+5% auf Schilde und den Schutz von Raumschiffen</span>',
603 => 'Der Ingeneur ist ein Spezialist im Energiemanagement. In Friedenszeiten optimiert er die Netzeffektivitaet der Kolonien.<br><br><span style="color:red">+5% Energie</span>',
604 => 'Die Gilde der Technokraten wird als Gruppe von wissenschaftlichen Genies anerkannt. Man findet sie an der Stelle, wo die Technik ihre Grenzen erreicht. Noch keiner hat es geschafft, die Verschlüsselung eines Technokraten zu dechiffrieren, welche die Forscher im ganzen Universum inspiriert.<br><br><span style="color:red">-5% der Konstruktionszeit von Raumschiffen</span>',
...
612 => 'Der Zerstörer ist ein Offizier ohne Erbarmen. Er hat schon die Bevölkerungen ganzer Planeten abgeschlachtet, nur zu seinem Vergnügen. Im Moment Arbeitet er an einer neuen Methode zur Produktion von Todessternen.<br><br><span style="color:red">2 RIP Konstruktionen anstelle von einer.</span>',
613 => 'Der General ist eine ehrwürdige Person, der seit vielen Jahren in der Armee dient. Durch unzählige Manöver hat der General strategien entwickelt um die Flottengeschwindigkeiten, in sämtlichen konstellationen verschiedenster Shiffstypen ,zu optimieren.<br><br><span style="color:red">+10% Geschwindigkeit der Schiffe</span>',
