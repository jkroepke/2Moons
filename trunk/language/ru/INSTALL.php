...
$LNG['req_desc']              = 'Перед продолжением установки 2Moons выполнит проверку файлов конфигурации Вашего сервера на соответствие необходимым требованиям использования 2Moons. Пожалуйста, прочитайте внимательно результаты и не продолжайте установку, пока проверка не будет успешно пройдена по всем пунктам. Если Вы хотите использовать любую из функций перечисленных ниже модулей, Вы должны убедиться, что проверка успешно пройдена.';
$LNG['reg_yes']               = 'Да';
$LNG['reg_no']                = 'Нет';
$LNG['reg_found']             = 'Да';
...
$LNG['step3_desc']            = 'Таблицы базы данных успешно созданы и заполнены. Переходите к следующему шагу, чтобы завершить установку 2Moons.';
