...
$LNG['rules']                        = array(
	...
	При игре в одной вселенной двух человек с одинаковым IP адресом, необходимо уведомить об этом Администрацию.
	...
	Во всех остальных случаях (дележ САБ, помощь в сборе поля обломков, и т. д.) игроки должны уведомить Администрацию.",
	...
	"Спам, реклама, порнография" =>

	"Спам, реклама, эротические и порнографические материалы в любой форме запрещены. Нарушение влечёт за собой бессрочную блокировку аккаунта с РО с последующим его удалением.",
	...
	Оспаривание наказания осуществляется только между закблокированным и заблокировавшим лицами.
	Оспаривание должно происходить без эмоций и в деловом тоне.
	Администрация оставляет за собой право не брать во внимание доводы заблокированного.",

    "Возмещение убытков" =>

	"Администрация не возмещает убытки, нанесённые игрокам из-за неправильной работы игры, игровых ошибок, недочётов, сбоев игры.",
