...
{if $game_captcha}<script type="text/javascript">$(document).ready(function(){ldelim}showRecaptcha();{rdelim});</script>{/if}
...
<form action="?page=reg&amp;mode=send" name="reg_form" method="post">
<br>
<br>
<table style="width:100%;text-align:center;padding-top:3px;">
	<tr>
		<td>{$user_reg}:</td>
		<td><input name="character" size="30" maxlength="20" type="text" tabindex="0"></td> 
	</tr>
	<tr>
		<td>{$pass_reg}:</td>
		<td><input name="password" size="30" maxlength="20" type="password" tabindex="1"></td>
	</tr>
	<tr>
		<td>{$pass2_reg}:</td>
		<td><input name="password2" size="30" maxlength="20" type="password" tabindex="2"></td>
	</tr>
	<tr>
		<td>{$email_reg}:</td>
		<td><input name="email" size="30" maxlength="40" type="text" tabindex="3"></td>
	</tr>
	<tr>
		<td>{$email2_reg}:</td>
		<td><input name="email2" size="30" maxlength="40" type="text" tabindex="4"></td>
	</tr>
	{if $game_captcha}
	<tr>
	...
	<div><a href="javascript:Recaptcha.showhelp()">{$captcha_help}</a></div>
		...
		<td><br><center><div id="display_captcha" style="display:none"><div id="recaptcha_image"></div><input type="text" id="recaptcha_response_field" size="30" maxlength="40" tabindex="6" name="recaptcha_response_field"></div></center></td>
	</tr>
	{/if}
	<tr>
	...
	<tr>
		<th colspan="2"><input class="input-button" type="submit" value="Absenden"></th>
	</tr>
</table>
</form></th></tr>
</table>
