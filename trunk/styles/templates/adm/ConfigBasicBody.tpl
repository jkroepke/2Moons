...
<tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_ttf_file_info}"></td>
</tr><tr>
...
<tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_del_oldstuff_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_del_user_manually_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_del_user_automatic_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_del_user_sendmail_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_recaptcha_desc}"></td>
</tr><tr>
	...
	<th><center><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_smtp_info}"></center></th>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_smtp_sendmail_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_smtp_host_info}"></td>
</tr><tr>
	<td>{$LNG.se_smtp_ssl}</td>
	<td>{html_options name=smtp_ssl options=$Selector.encry selected=$smtp_ssl}</td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_smtp_ssl_info}"></td>
</tr><tr>
	<td>{$LNG.se_smtp_port}</td>
	<td><input name="smtp_port" size="20" value="{$smtp_port}" type="text" autocomplete="off"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_smtp_port_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_google_info}"></td>
</tr><tr>
    <td>{$LNG.se_google_key}</td>
    <td><input name="ga_key" size="20" maxlength="15" value="{$ga_key}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" name="{$LNG.se_google_key_info}"></td>
</tr><tr>
