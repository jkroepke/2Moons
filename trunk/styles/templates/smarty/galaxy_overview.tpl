...
<div id="content">
	...
	<th style="white-space: nowrap;" width="125">{if $GalaxyRow.action.esp}<a href="javascript:doit(6,{$galaxy},{$system},{$planet},1,{$spio_anz});"><img src="{$dpath}img/e.gif" title="{$gl_spy}" border="0"></a>&nbsp;{/if}{if $GalaxyRow.action.message}<a href="javascript:f('game.php?page=messages&amp;mode=write&amp;id={$GalaxyRow.user.id}');"><img src="{$dpath}img/m.gif" title="{$write_message}" border="0"></a>&nbsp;{/if}{if $GalaxyRow.action.buddy}<a href="javascript:f('game.php?page=buddy&amp;mode=2&amp;u={$GalaxyRow.user.id}');"><img src="{$dpath}img/b.gif" title="{$gl_buddy_request}" border="0"></a>&nbsp;{/if}{if $GalaxyRow.action.missle}<a href="?page=galaxy&mode=2&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;current={$current_planet}"><img src="{$dpath}img/r.gif" title="{$gl_missile_attack}" border="0"></a>{/if}</th>
