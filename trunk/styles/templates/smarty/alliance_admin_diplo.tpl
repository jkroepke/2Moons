...
<div id="content" class="content">
	<table width="520" align="center">
		...
		<tr><th width="90%" colspan="2">{$name.0}</th><th><a href="?page=alliance&amp;mode=admin&amp;edit=diplo&amp;action=delete&amp;id={$id}&amp;level=4" onclick="javascript:return confirm('{$al_diplo_confirm_delete}');"><img src="{$dpath}pic/abort.gif" border="0" alt=""></a></th></tr>
		{foreachelse}
		<tr><th colspan="3">{$al_diplo_no_entry}</th></tr>
		{/foreach}
        <tr>
		...
		<tr><th width="60%">{$name.0}</th><th>{$al_diplo_level.{$name.2}}</th><th><a href="?page=alliance&amp;mode=admin&amp;edit=diplo&amp;action=accept&amp;id={$id}&amp;level={$name.2}"><img src="{$dpath}pic/key.gif" border="0" alt=""></a><a href="?page=alliance&amp;mode=admin&amp;edit=diplo&amp;action=decline&amp;id={$id}&amp;level={$name.2}"><img src="{$dpath}pic/abort.gif" border="0" alt=""></a></th></tr>
		{foreachelse}
