...
<tr>
	<th><a href="#" onmouseover='return overlib("{if $RangeList.ranking == 0}<font color=&#39;#87CEEB&#39;>*</font>{elseif $RangeList.ranking < 0}<font color=&#39;red&#39;>-{$RangeList.ranking}</font>{elseif $RangeList.ranking > 0}<font color=&#39;green&#39;>+{$RangeList.ranking}</font>{/if}", WIDTH, 10);' onmouseout='return nd();'>{$smarty.foreach.RangeList.iteration - 1 + $range}</a></th>
