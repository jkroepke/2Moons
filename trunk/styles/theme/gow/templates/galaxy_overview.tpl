...
<div id="content" class="content">
	...
	<td style="white-space: nowrap;">{if $GalaxyRow.action}{if $GalaxyRow.action.esp}<a href="javascript:doit(6,{$galaxy},{$system},{$planet},1,{$spio_anz});"><img src="{$dpath}img/e.gif" title="{$gl_spy}" alt=""></a>&nbsp;{/if}{if $GalaxyRow.action.message}<a href="#" onclick="return Dialog.PM({$GalaxyRow.user.id});"><img src="{$dpath}img/m.gif" title="{$write_message}" alt=""></a>&nbsp;{/if}{if $GalaxyRow.action.buddy}<a href="javascript:OpenPopup('game.php?page=buddy&amp;mode=2&amp;u={$GalaxyRow.user.id}', '', 720, 300);"><img src="{$dpath}img/b.gif" title="{$gl_buddy_request}" alt=""></a>&nbsp;{/if}{if $GalaxyRow.action.missle}<a href="?page=galaxy&amp;mode=2&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}"><img src="{$dpath}img/r.gif" title="{$gl_missile_attack}" alt=""></a>{/if}{else}-{/if}</td>
