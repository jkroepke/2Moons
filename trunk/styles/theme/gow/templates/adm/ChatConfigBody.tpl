...
<tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" onMouseOver='return overlib("{$ch_socket_host_info}", CENTER,OFFSETX, -150, OFFSETY, -20, width, 250);' onMouseOut='return nd();'></td>
</tr><tr>
	<td>{$ch_socket_ip}</td>
	<td><input name="chat_socket_ip" value="{$chat_socket_ip}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" onMouseOver='return overlib("{$ch_socket_ip_info}", CENTER,OFFSETX, -150, OFFSETY, -20, width, 250);' onMouseOut='return nd();'></td>
</tr><tr>
	<td>{$ch_socket_port}</td>
	<td><input name="chat_socket_port" value="{$chat_socket_port}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" onMouseOver='return overlib("{$ch_socket_port_info}", CENTER,OFFSETX, -150, OFFSETY, -20, width, 250);' onMouseOut='return nd();'></td>
</tr><tr>
	<td>{$ch_socket_chatid}</td>
	<td><input name="chat_socket_port" value="{$chat_socket_chatid}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" onMouseOver='return overlib("{$ch_socket_chatid_info}", CENTER,OFFSETX, -150, OFFSETY, -20, width, 250);' onMouseOut='return nd();'></td>
</tr>
<tr>
