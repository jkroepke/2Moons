...
function ShowMessageListPage()
{
	...
	if ($Selected < 100)
		$Mess      = max(1, $GLOBALS['DATABASE']->getFirstCell("SELECT COUNT(*) FROM ".MESSAGES." WHERE message_type = '".$Selected."' AND message_universe = '".$_SESSION['adminuni']."';"));
	elseif ($Selected == 100)
		$Mess      = max(1, $GLOBALS['DATABASE']->getFirstCell("SELECT COUNT(*) FROM ".MESSAGES." WHERE message_universe = '".$_SESSION['adminuni']."';"));
