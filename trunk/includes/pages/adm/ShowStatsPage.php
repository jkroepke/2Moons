...
function ShowStatsPage() 
{
	...
	if ($_POST)
	{
		$CONF['stat_settings']			= request_var('stat_settings', '');
		$CONF['stat'] 					= request_var('stat', '');
		$CONF['stat_update_time']		= request_var('stat_update_time', '');
		$CONF['stat_level']				= request_var('stat_level', '');
