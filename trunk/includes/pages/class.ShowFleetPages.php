...
class ShowFleetPages extends FleetFunctions
{
	...
	public static function ShowFleet1Page($CurrentUser, $CurrentPlanet)
	{
		...
		$template->assign_vars(array(
			...
			'fleetspeedfactor'		=> str_replace(",",".",((time() - $CurrentUser[$resource[706]] <= 0) ? (1 - $ExtraDM[706]['add']) : 1)),
	...
	public static function ShowFleet2Page($CurrentUser, $CurrentPlanet)
	{
		...
		$template->assign_vars(array(
			...
			'thismetal'				 		=> $CurrentPlanet['metal'],
			'thiscrystal'			 		=> $CurrentPlanet['crystal'],
			'thisdeuterium'			 		=> $CurrentPlanet['deuterium'],
