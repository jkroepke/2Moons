       ...
       private function BuildHostileFleetPlayerLink($FleetRow, $Names)
        {
                ...
                return $Names['owner_username'].' <a href="javascript:f(\'game.php?page=messages&amp;mode=write&amp;id='.$FleetRow['fleet_owner'].'\',\'\');"><img src="'.$USER['dpath'].'img/m.gif" title="'.$LNG['write_message'].'" border="0" alt=""></a>';
        }
