...
class template extends Smarty
{
	...
	private function topnav()
	{
		...
		$this->assign_vars(array(
			...
			'js_metal_max'		=> $this->planet["metal_max"],
			'js_crystal_max'	=> $this->planet["crystal_max"],
			'js_deuterium_max' 	=> $this->planet["deuterium_max"],
			'js_metal_hr'		=> $this->planet['metal_perhour'] + $this->GameConfig['metal_basic_income'] * $this->GameConfig['resource_multiplier'],
			'js_crystal_hr'		=> $this->planet['crystal_perhour'] + $this->GameConfig['crystal_basic_income'] * $this->GameConfig['resource_multiplier'],
			'js_deuterium_hr'	=> $this->planet['deuterium_perhour'] + $this->GameConfig['deuterium_basic_income'] * $this->GameConfig['resource_multiplier'],
