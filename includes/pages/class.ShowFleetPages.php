...
class ShowFleetPages extends FleetFunctions
{
	...
	public static function ShowFleetPage($CurrentUser, $CurrentPlanet)
	{
		...
		$template->assign_vars(array(
			...
			'fl_bonus'				=> $lang['fl_bonus'],
			'fl_bonus_attack'		=> $lang['fl_bonus_attack'],
			'fl_bonus_defensive'	=> $lang['fl_bonus_defensive'],
			'fl_bonus_shield'		=> $lang['fl_bonus_shield'],
			'bonus_comp'			=> $lang['tech'][115],
			'bonus_impul'			=> $lang['tech'][117],
			'bonus_hyper'			=> $lang['tech'][118],
			'galaxy'				=> $galaxy,
			'system'				=> $system,
			'planet'				=> $planet,
