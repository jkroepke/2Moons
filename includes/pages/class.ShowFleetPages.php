...
class ShowFleetPages extends FleetFunctions
{
	public static function ShowFleetPage()
	{
		...
		while ($CurrentFleetsRow = $db->fetch_array($CurrentFleets))
		{
			...
			$FlyingFleetList[]	= array(
				...
				'start_time'	=> date($LNG['php_tdformat'], $CurrentFleetsRow['fleet_start_time']),
				...
				'end_time'		=> date($LNG['php_tdformat'], $CurrentFleetsRow['fleet_end_time']),
	...
	public static function ShowFleet3Page()
	{
		...
		$template->assign_vars(array(
			...
			'start_time' 			=> date($LNG['php_tdformat'], $fleet['start_time']),
			'end_time' 				=> date($LNG['php_tdformat'], $fleet['end_time']),
