...
$lang['info'][124]['description'] = 'Higher levels in astrophysics enable the construction of laboratories, with which more and more ships can be equipped.<br> Also long expedition trips are possible in unexplored areas. <br>Every two levels of this technology allow further progress to colonize outer space.';
...
// ----------------------------------------------------------------------------------------------------------
// Schiffe
$lang['info'][202]['name']        = 'Light Cargo';
...
$lang['info'][203]['name']        = 'Heavy Cargo';
...
$lang['info'][217]['name']        = 'Star Freighter';
...
$lang['info'][601]['description'] = '<br><br>The Geologist is a expert in astro-mineralogy and crystalography. He assists his teams in metallurgy and chemistry as he also takes care of the interplanetary communications optimising the use and refining of the raw material along the empire.<br><br><font color="red"> +%s%% to production of resources. Max Level %s</font>';
$lang['info'][602]['name']       = 'Admiral';
$lang['info'][602]['description'] = '<br><br>The Admiral is an experienced veteran and a skillful strategist. The hardest battle is able to get an idea of the situation and contact their admirals subordinates. A wise emperor could rely on their help during the fighting.<br><br><font color="red">+%s%% Attack, Shielding and Armor. Max Level %s</font>';
$lang['info'][603]['name']       = 'Engineer';
$lang['info'][603]['description'] = '<br><br>The Engineer is a specialist in energy management. In peacetime, it increases the energy of all the colonies.<br><br><font color="red">+%s%% Energy . Max Level %s </font>';
$lang['info'][604]['name']       = 'Technocrat';
$lang['info'][604]['description'] = '<br><br>The guild of the Technocrats is composed of genius scientists, and you will find them always over the realm where all human logic would be defied. For thousands of years, no normal humans have ever cracked the code of a Technocrat. The Technocrat inspires the researchers of the empire with his presence.<br><br><font color="red">-%s%% Of the construction time of spacecraft. Max Level %s </font>';
$lang['info'][605]['name']       = 'Constructor';
$lang['info'][605]['description'] = '<br><br>The Constructor has altered their DNA, only one of these men can build an entire city in a short time. <br><br><font color="red">-%s%% Of the construction time. Max Level %s</font>';
$lang['info'][606]['name']       = 'Scientologist';
$lang['info'][606]['description'] = '<br><br>Scientists are part of a guild to concurrent technocrats. They specialize in the improvement of technologies. <br><br><font color="red">-%s%% Of research time. Max Level %s</font>';
$lang['info'][607]['name']       = 'Storage expert';
$lang['info'][607]['description'] = '<br><br>Storage is part of the ancient brotherhood of the planet Hsac. His motto is to win the maximum, which is why we need huge storage space. Thus has developed a new storage technique. <br><br><font color="red">+%s%% Storage capacity. Max Level %s</font>';
$lang['info'][608]['name']       = 'Minister of Defence';
$lang['info'][608]['description'] = '<br><br>The Minister of Defence is a member of the Imperial Army. focus on your job allows you to build a formidable defense in a short period of time.<br><br><font color="red">-%s%% Of the construction time for defenses. Max Level %s</font>';
$lang['info'][609]['name']       = 'Guardian';
$lang['info'][609]['description'] = '<br><br>The Guardian is part of the Imperial Army and its goal is to develop technologies that improve the planetary defenses.<br><br><font color="red">unlocks Giant Shield Dome. Max Level %s</font>';
$lang['info'][610]['name']       = 'Spy';
$lang['info'][610]['description'] = '<br><br>The Spy is an enigmatic person. No one ever saw his true face, the only way would be killed. <br><br><font color="red">+%s Espionage Level. Max Level %s</font>';
$lang['info'][611]['name']       = 'Commander';
$lang['info'][611]['description'] = '<br><br>The Commander is part of the Imperial Army and has mastered the art of managing fleets. His brain can calculate the trajectories of a large number of fleets.<br><br><font color="red">+%s Fleet slots. Max Level %s</font>';
$lang['info'][612]['name']       = 'Destroyer';
$lang['info'][612]['description'] = '<br><br>The Destroyer is a member of the Imperial Army without mercy. Slaughter everything that is on its way just for fun. It is currently developing nothing.<br><br><font color="red">Nothing. Max Level %s</font>';
$lang['info'][613]['name']       = 'General';
$lang['info'][613]['description'] = '<br><br>The General is a person who has served for many years to the Imperial Army. manufacturers produce ships faster in its presence. <br><br><font color="red">+%s%% Speed of production for ships. Max Level %s</font>';
$lang['info'][614]['name']       = 'Conqueror';
$lang['info'][614]['description'] = '<br><br>The Conqueror is a member of the Imperial Army, it has the ability to navigate a particular type of ship that no one else could do or take off.<br><br><font color="red">Max Level %s</font>';
$lang['info'][615]['name']       = 'Emperor';
$lang['info'][615]['description'] = '<br><br>The Emperor placed under his command available to all officers in the empire, combining their skills to dominate the universe and to become an opponent almost invincible. <br><br><font color="red">Max Level %s</font>';

// ----------------------------------------------------------------------------------------------------------
// ExtraDM - Dummy vars.
$lang['info'][700]['name']                = 'Weapons Optimization';
$lang['info'][700]['description'] = 'Weapons Optimization';
$lang['info'][701]['name']                = 'Shield Optimization';
$lang['info'][701]['description'] = 'Shield Optimization';
$lang['info'][702]['name']                = 'Construction Coordination';
$lang['info'][702]['description'] = 'Construction Coordination';
$lang['info'][703]['name']                = 'Raw material Optimization';
$lang['info'][703]['description'] = 'Raw material Optimization';
$lang['info'][704]['name']                = 'Energy Optimization';
$lang['info'][704]['description'] = 'Energy Optimization';
$lang['info'][705]['name']                = 'Research Optimization';
$lang['info'][705]['description'] = 'Research Optimization';
$lang['info'][706]['name']                = 'Fleet Coordination';
$lang['info'][706]['description'] = 'Fleet Coordination';
