...
class GalaxyRows
{
	...
	protected function getAllowedMissions()
	{
		...
		$this->galaxyData[$this->galaxyRow['planet']]['missions']	= array(
			...
			9	=> !$this->galaxyData[$this->galaxyRow['planet']]['ownPlanet'] && $PLANET[$GLOBALS['VARS']['ELEMENT'][214]['name']] > 0 && isModulAvalible(MODULE_MISSION_DESTROY),
			10	=> !$this->galaxyData[$this->galaxyRow['planet']]['ownPlanet'] && $PLANET[$GLOBALS['VARS']['ELEMENT'][503]['name']] > 0 && isModulAvalible(MODULE_MISSION_ATTACK) && isModulAvalible(MODULE_MISSILEATTACK) && $this->inMissileRange(),
		);
	}
