                                ...
                                <table class="layout" style="width: 320px; height: 65px;">
                                  <tbody>
                                    <tr align="center">
                                      ...
                                      <td><span class="Estilo5">{$universe}</span></td>
                                      <td><select name="Uni" style="width: 188px; position: relative; left: 4px;">
...
<table class='default_box-header box-header'><tr><td class='default_box-header-left box-header-left'>&nbsp;</td><td class='default_box-header-center box-header-center'>&nbsp;</td><td class='default_box-header-right box-header-right'>&nbsp;</td></tr></table></td></tr><tr><td><table class='default_box-content box-content'><tr><td class='default_box-content-left box-content-left'>&nbsp;</td><td class='default_box-content-center box-content-center'><div class='default_content'><table  class='menu'><tr class='row1'><td class='menu-item' style='width: 50%'><table   onmouseover='buttonOver(this, "button button-normal-over")' onmouseout='buttonOut(this)' class='button button-normal'><tr><td class='button-left'><a href='about.html'>&nbsp;</a></td>
                                <td class='button-center'><a onclick="ajax('?page=lostpassword&amp;'+'getajax=1');" style="cursor:pointer;">{$lostpassword}</a></td>
                                <td class='button-right'><a onclick="ajax('?page=lostpassword&amp;'+'getajax=1');" style="cursor:pointer;">&nbsp;</a></td></tr></table></td><td class='menu-separator' ><div >&nbsp;</div></td><td class='menu-item'><table   onmouseover='buttonOver(this, "button button-normal-over")' onmouseout='buttonOut(this)' class='button button-normal'><tr><td class='button-left'><a href='screenshots.html'>&nbsp;</a></td>
                                <td class='button-center'><div align="center"><a onclick="ajax('?page=screens&amp;'+'getajax=1');" style="cursor:pointer;">{$screenshots}</a></div></td><td class='button-right'><a href='screenshots.html'>&nbsp;</a></td></tr></table></td></tr></table></div></td><td class='default_box-content-right box-content-right'>&nbsp;</td></tr></table></td></tr><tr><td><table class='default_box-footer box-footer'><tr><td class='default_box-footer-left box-footer-left'>&nbsp;</td><td class='default_box-footer-center box-footer-center'>&nbsp;</td><td class='default_box-footer-right box-footer-right'>&nbsp;</td></tr></table></td></tr></table>
          <center>
            <small><b><a onclick="ajax('?page=disclamer&amp;'+'getajax=1');" style="cursor:pointer;">{$menu_disclamer}</a> - <strong>&copy; {$servername}</strong></b></small>
          </center>
