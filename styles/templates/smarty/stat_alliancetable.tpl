...
<tr>
	<th><a href="#" onmouseover='return overlib("{if $RangeList.ranking == 0}<font color=&#34;#87CEEB"&#34;>*</font>{elseif $RangeList.ranking < 0}<font color=&#34;red&#34;>-{$RangeList.ranking}</font>{elseif $RangeList.ranking > 0}<font color=&#34;green&#34;>+{$RangeList.ranking}</font>{/if}");' onmouseout='return nd();'>{$RangeList.rank}</a></th>
