...
<img src="../styles/images/Adm/arrowright.png" width="16" height="10"/> {ad_back_to_menu}</a></th>
	...
	<td class="c" colspan="3">{ad_defenses_title}</td>
</tr><tr>
	<th colspan="2">{ad_planet_id}</th>
	<th><input name="id" type="text" value="0" size="3" /></th>
</tr><tr>
	<td class="c">{ad_number}</td>
	<td class="c">{ad_defenses}</td>
	<td class="c">{ad_defenses_number}</td>
</tr><tr>
	<th>1</th>
	...
	<input type="Submit" value="{ad_add_defenses_button}" name="add" />&nbsp;
	<input type="Submit" value="{ad_delete_defenses_button}" name="delete"/></th>
</tr>
</table>
</form>
</body>