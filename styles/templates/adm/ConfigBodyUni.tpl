...
<tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_normal_speed}"></td>
</tr><tr>
	<td>{$se_fleet_speed}</td>
	<td><input name="fleet_speed" value="{$fleet_speed}" type="text" maxlength="5"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_normal_speed_fleet}"></td>
</tr><tr>
	<td>{$se_resources_producion_speed}</td>
	<td><input name="resource_multiplier" value="{$resource_multiplier}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_normal_speed_resoruces}"></td>
</tr><tr>
	<td>{$se_halt_speed}</td>
	<td><input name="halt_speed" value="{$halt_speed}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_normal_speed_halt}"></td>
</tr><tr>
	<td>{$se_forum_link}</td>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_max_elements_build_info}"></td>
</tr><tr>
	<td>{$se_max_elements_tech}</td>
	<td><input name="max_elements_tech" maxlength="3" size="3" value="{$max_elements_tech}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_max_elements_tech_info}"></td>
</tr><tr>
	<td>{$se_max_elements_ships}</td>
	<td><input name="max_elements_ships" maxlength="3" size="3" value="{$max_elements_ships}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_max_elements_ships_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_max_fleet_per_build_info}"></td>
</tr><tr>
	<th colspan="2">{$se_ref}</th><th>&nbsp;</th>
</tr><tr>
	<td>{$se_ref_active}</td>
	<td><input name="ref_active"{if $ref_active} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_ref_active_info}"></td>
</tr><tr>
	<td>{$se_ref_bonus}</td>
	<td><input name="ref_bonus" maxlength="6" size="8" value="{$ref_bonus}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_ref_bonus_info}"></td>
</tr><tr>
	<td>{$se_ref_minpoints}</td>
	<td><input name="ref_minpoints" maxlength="20" size="25" value="{$ref_minpoints}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_ref_minpoints_info}"></td>
</tr><tr>
	<td>{$se_ref_max_referals}</td>
	<td><input name="ref_max_referals" maxlength="6" size="8" value="{$ref_max_referals}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_ref_max_referals_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_metal_start_info}"></td>
</tr><tr>
	<td>{$se_crystal_start}</td>
	<td><input name="crystal_start" maxlength="11" size="11" value="{$crystal_start}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_crystal_start_info}"></td>
</tr><tr>
	<td>{$se_deuterium_start}</td>
	<td><input name="deuterium_start" maxlength="11" size="11" value="{$deuterium_start}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_deuterium_start_info}"></td>
</tr><tr>
	<td>{$se_darkmatter_start}</td>
	<td><input name="darkmatter_start" maxlength="11" size="11" value="{$darkmatter_start}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_darkmatter_start_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_min_build_time_info}"/></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_verfiy_mail_info}"/></td>
</tr><tr>
	<td>{$se_admin_protection}</td>
    <td><input name="adm_attack"{if $adm_attack} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_title_admins_protection}"/></td>
</tr><tr>
	<td>{$se_debug_mode}</td>
	<td><input name="debug"{if $debug} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_debug_message}"></td>
</tr><tr>
	<td>{$se_ships_cdr}</td>
	<td><input name="Fleet_Cdr" maxlength="3" size="3" value="{$shiips}" type="text"> %</td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_ships_cdr_message}"></td>
</tr><tr>
	<td>{$se_def_cdr}</td>
	<td><input name="Defs_Cdr" maxlength="3" size="3" value="{$defenses}" type="text"> %</td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_def_cdr_message}"></td>
</tr><tr>
	<td>{$se_max_galaxy}</td>
	<td><input name="max_galaxy" maxlength="3" size="3" value="{$max_galaxy}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_max_galaxy_info}"></td>
</tr><tr>
	<td>{$se_max_system}</td>
	<td><input name="max_system" maxlength="5" size="5" value="{$max_system}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_max_system_info}"></td>
</tr><tr>
	<td>{$se_max_planets}</td>
	<td><input name="max_planets" maxlength="3" size="3" value="{$max_planets}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_max_planets_info}"></td>
</tr><tr>
	<td>{$se_min_player_planets}</td>
	<td><input name="min_player_planets" maxlength="3" size="3" value="{$min_player_planets}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_max_player_planets_info}"></td>
</tr><tr>
	<td>{$se_max_player_planets}</td>
	<td><input name="max_player_planets" maxlength="3" size="3" value="{$max_player_planets}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_min_player_planets_info}"></td>
</tr><tr>
	<td>{$se_planet_factor}</td>
	<td><input name="planet_factor" maxlength="3" size="3" value="{$planet_factor}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_planet_factor_info}"></td>
</tr><tr>
	<td>{$se_max_overflow}</td>
	<td><input name="max_overflow" maxlength="3" size="3" value="{$max_overflow}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_max_overflow_info}"></td>
</tr><tr>
	<td>{$se_moon_factor}</td>
	<td><input name="moon_factor" maxlength="3" size="3" value="{$moon_factor}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_moon_factor_info}"></td>
</tr><tr>
	<td>{$se_moon_chance}</td>
	<td><input name="moon_chance" maxlength="3" size="3" value="{$moon_chance}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_moon_chance_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_deuterium_cost_galaxy_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_darkmatter_cost_trader_info}"></td>
</tr><tr>
	<td>{$se_factor_university}</td>
	<td><input name="factor_university" maxlength="3" size="3" value="{$factor_university}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_factor_university_info}"></td>
</tr><tr>
	<td>{$se_max_fleets_per_acs}</td>
	<td><input name="max_fleets_per_acs" maxlength="3" size="3" value="{$max_fleets_per_acs}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_max_fleets_per_acs_info}"></td>
</tr><tr>
	<td>{$se_silo_factor}</td>
	<td><input name="silo_factor" maxlength="2" size="2" value="{$silo_factor}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_silo_factor_info}"></td>
</tr><tr>
	<td>{$se_vmode_min_time}</td>
	<td><input name="vmode_min_time" maxlength="11" size="11" value="{$vmode_min_time}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_vmode_min_time_info}"></td>
</tr><tr>
	<td>{$se_gate_wait_time}</td>
	<td><input name="gate_wait_time" maxlength="11" size="11" value="{$gate_wait_time}" type="text"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_gate_wait_time_info}"></td>
</tr><tr>
	<td>{$se_debris_moon}</td>
	<td><input name="debris_moon"{if $debris_moon} checked="checked"{/if} type="checkbox"></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_debris_moon_info}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_noob_protect_e2}"></td>
</tr><tr>
	...
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_news_info}"></td>
</tr><tr>
    <td>{$se_news}</td>
    <td><textarea name="NewsText" cols="80" rows="5">{$NewsTextVal}</textarea></td>
	<td><img src="./styles/images/Adm/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_news_limit}"></td>
</tr>
<tr>
