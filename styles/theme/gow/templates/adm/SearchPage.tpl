...
<img src="./styles/images/Adm/GO.png" onClick="javascript:$('#search').slideToggle()" style="cursor:pointer;padding-right:60px;" class="tooltip" name="{$ac_minimize_maximize}">
</td>
</tr>
</table>
